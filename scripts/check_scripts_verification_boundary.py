...
REFERENCE_PATHS = [
    ...
    "internal_docs/verification/artifact_schema_and_retention.md",
    "internal_docs/verification/baseline_governance.md",
    "internal_docs/verification/regression_corpus_policy.md",
    "scripts",
    "verification/areas",
