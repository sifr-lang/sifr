...
Inputs verified:
- Pass-4 review (`reviews/ad-hoc-production-network-http-m3-opus-review-pass-4.md`) and its single blocker B1 (merge-gate evidence on disk contradicted ledger PASS claim).
