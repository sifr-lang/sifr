...
- **N5 (reviewer assignment)** — resolved: `execution.md:256` names Claude Opus via `.cursor/skills/talk-to-claude-opus` and still requires a human reviewer on the PR.
