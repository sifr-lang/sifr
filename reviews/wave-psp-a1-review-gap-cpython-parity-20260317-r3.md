# wave_psp_a1 Review: CPython Parity Gap Analysis (Revision 3)
...
2. **REGRESSION PERSISTS**: `range()` keyword arguments still incorrectly accepted
...
1. 🔴 **range() keyword bug** - Partial fix applied, all-keyword form still broken
