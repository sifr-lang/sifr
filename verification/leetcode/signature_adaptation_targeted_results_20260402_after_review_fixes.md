# Signature Adaptation Targeted Validation (After Review Fixes, 2026-04-02)
...
| `0946_validate_stack_sequences` | PASS | FAIL | build error: cargo build failed:    Compiling sifr_output v0.1.0 (/private/var/folders/lq/l19_y_rn76b8vprfvdjn9zch0000gn/T/sifr_run_cache_stage_87735_1775090532789799000/sifr_output) warning: unnecessary parentheses around `while` condition   --> src/main.rs:6 |
...
| `0098_validate_binary_search_tree` | PASS | FAIL | build error: cargo build failed:    Compiling sifr_output v0.1.0 (/private/var/folders/lq/l19_y_rn76b8vprfvdjn9zch0000gn/T/sifr_run_cache_stage_89073_1775090550306741000/sifr_output) warning: unnecessary parentheses around `return` value   --> src/main.rs:46:1 |
...
- check pass: 14/36
- run pass: 12/36
- fixtures with failure in check or run: 24
