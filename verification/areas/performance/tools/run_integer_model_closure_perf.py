#!/usr/bin/env python3
"""Run INT-8 integer-model closure performance and allocation probes."""
...
name = "integer_model_closure_perf_probe"
version = "0.1.0"
edition = "2021"
...
def main() -> None:
    ...
    print("Integer model closure performance probe")
    ...
    print("Integer model closure performance probe: PASS")
