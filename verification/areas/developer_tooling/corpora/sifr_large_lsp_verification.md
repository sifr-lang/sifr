...
`verification/areas/developer_tooling/corpora/sifr-large-lsp-verification` is a git submodule pointing at the
...
```bash
git submodule update --init verification/areas/developer_tooling/corpora/sifr-large-lsp-verification
```
...
```bash
cd verification/areas/developer_tooling/corpora/sifr-large-lsp-verification
