...
| global `--config <file-or-override>` | `--config <file-or-override>` or reviewed Sifr equivalent | fmt_cli_config_override_precedence |
| global `--isolated` | `--isolated` or reviewed Sifr equivalent | fmt_cli_isolated_ignores_config |
