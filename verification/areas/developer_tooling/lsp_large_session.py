...
SUBMODULE_ROOT = REPO_ROOT / "verification" / "areas" / "developer_tooling" / "corpora" / "sifr-large-lsp-verification"
...
def load_manifest() -> dict[str, Any]:
    if not MANIFEST_PATH.exists():
        raise LspProtocolError(
            ...
            "`scripts/clone_subrepos.sh` or `git submodule update --init verification/areas/developer_tooling/corpora/sifr-large-lsp-verification`"
        )
