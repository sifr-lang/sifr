...
the redacted `Rust bridge panicked` message. The paired
negative generated-build test replaces the bridge source with storage,
returned-deferred-call, and unmanaged-thread escapes that rustc rejects before
a package can run.
