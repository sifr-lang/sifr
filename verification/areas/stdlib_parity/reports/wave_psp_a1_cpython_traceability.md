...
| `zip(..., strict=True)` | `test_builtin.py:2181-2286` | `waived` | `verification/areas/stdlib_parity/reports/wave_psp_a1_cpython_traceability.md` | `strict` is intentionally deferred; this wave closes variadic arity and base iterable lowering first. |
...
| `map(..., strict=True)` | `test_builtin.py:1395-1504` | `waived` | `verification/areas/stdlib_parity/reports/wave_psp_a1_cpython_traceability.md` | `strict` is deferred with the rest of the iterator-family parity work. |
