...
| `zip(..., strict=True)` | `test_builtin.py:2181-2286` | `waived` | `verification/areas/stdlib_parity/reports/stdlib_parity_a1_cpython_traceability.md` | `strict` is intentionally deferred; this wave closes variadic arity and base iterable lowering first. |
