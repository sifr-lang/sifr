...
| Unsupported CPython-shaped diagnostics | `crates/sifr_stdlib/src/lib.rs`, network/HTTP baseline capability e2e fail fixtures under `crates/sifr/tests/e2e/fail/` |
