...
| Unsupported Python locale globals | `verification/areas/stdlib_parity/reports/text_i18n_substrate_inventory.md` records `locale.setlocale`, `localeconv`, `strcoll`, `strxfrm`, and implicit preferred text encodings as unsupported/deferred/rejected; `crates/sifr/tests/e2e/fail/bare_cpython_locale_import.sifr` enforces the bare namespace boundary. |
