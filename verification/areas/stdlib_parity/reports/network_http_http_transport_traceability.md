...
| HTTPS transport | consumes M2 TLS with ALPN. | `network_http_https_h2_loopback.sifr` passes check/run with `h2` ALPN and long-lived localhost fixture certificate. |
