...
| `test_html` top-level module boundary | retain top-level `html.escape`/`html.unescape` readiness and keep package-wide `html.parser` family explicitly unsupported | `adapted` (shipped boundary) | `lib/sifr/html.sifr`, `crates/sifr/tests/e2e/pass/stdlib_html.sifr`, `crates/sifr/tests/e2e/fail/html_package_parser_unsupported.sifr` |
