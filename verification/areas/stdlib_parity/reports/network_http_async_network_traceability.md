...
| UDP | `deferred-to-phase-X` until a named production consumer plus fixture-insufficiency rationale is recorded. | No public `UdpSocket`; `network_http_udp_deferred.sifr` expects `SIFR-NAME-0004` for `from sifr.net import UdpSocket`. |
