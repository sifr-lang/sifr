...
| Unicode version alignment | Runtime unit test asserts `unicode_segmentation::UNICODE_VERSION == (17, 0, 0)`, matching the Unicode core capability Unicode 17.0.0 normalization/property/case data. |
| Deferred scope | Sentence boundaries and streaming cursor segmentation are intentionally deferred; Unicode segmentation capability provides owned-string collection APIs only. |
