...
| `SIFR_E2E_FIXTURE_MANIFEST=/tmp/sifr_m2_tls_fixtures_$$.json cargo test -p sifr --test e2e test_e2e_pass -- --nocapture` | PASS | Selected `network_http_tls_config_errors` and `network_http_tls_loopback_split`; 2 pass tests completed. |
