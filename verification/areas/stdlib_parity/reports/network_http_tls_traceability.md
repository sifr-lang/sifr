...
| TLS 1.3 session tickets | Resumption stays internal. Sifr does not expose tickets or key material. | Rustls 0.23.44 client configs request two tickets for new and resumed sessions through RFC 9149. Server configs emit two tickets and limit extension responses to two. `tls_configs_use_bounded_rfc9149_ticket_requests` asserts both policies. |
...
## Prior Latest-stable Refresh Evidence
