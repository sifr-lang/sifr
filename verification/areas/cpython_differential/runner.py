"""CPython differential verification area adapter."""
...
ACTUAL_ROOT = REPO_ROOT / "target" / "verification" / "actual" / "cpython_differential"
RESULT_JSON = REPO_ROOT / "target" / "verification" / "areas" / "cpython-differential-results.json"
CONFIG = AreaAdapterConfig(
    area="cpython_differential",
    owner="compiler/core-language",
    runner_name="cpython-differential-area",
    manifest_path=MANIFEST_PATH,
    actual_root=ACTUAL_ROOT,
    status_label="CPython differential",
)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path for machine-readable CPython differential area result summary.",
    )
