...
from .profile_commands import run_self_test as command_deadline_self_test
from .profile_policy_selftest import profile_schema_self_test
...
def run_all() -> list[str]:
    checks = [
        ...
        ("profile schema self-test", profile_schema_self_test),
        ("cache-aware step budget self-test", step_budget_self_test),
        ("subprocess deadline self-test", command_deadline_self_test),
