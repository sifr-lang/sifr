...
| subprocess constants (`PIPE`, `STDOUT`, `DEVNULL`) | ship stable constants for sync option-matrix parity anchors | `adapted` | `crates/sifr/tests/e2e/pass/phase_psp_runtime_4_subprocess_sync_boundary_governance.sifr`, `demos/subprocess/main.sifr` |
