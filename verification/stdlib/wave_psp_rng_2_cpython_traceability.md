...
- Demo:
  - `demos/rng_hashlib_base64_bytes/main.sifr`
- Negative fixtures:
  - `crates/sifr/tests/e2e/fail/phase_psp_rng_2_sha3_object_model_unsupported.sifr`
  - `crates/sifr/tests/e2e/fail/phase_psp_rng_2_hashlib_pbkdf2_hmac_unsupported.sifr`
  - `crates/sifr/tests/e2e/fail/phase_psp_rng_2_hashlib_scrypt_unsupported.sifr`
