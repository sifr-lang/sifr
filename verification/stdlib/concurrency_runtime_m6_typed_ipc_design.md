...
7. Keep Windows process-pipe fixture evidence host-limited until a deterministic Windows fixture is accepted, and keep generated worker boundaries `deferred-to-phase-X` until a future Sifr-native worker API is accepted.
