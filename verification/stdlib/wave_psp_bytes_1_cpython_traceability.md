...
| compatibility helper parity (`lib/sifr/bytes.sifr`) | keep compatibility exports while moving canonical semantics to first-class `bytes` | `adapted` | `demos/ad_hoc_bytes_wave1_core_type_demo.sifr`<br>`demos/ad_hoc_bytes_wave1_iteration_and_equality_demo.sifr` |
...
- Demos:
  - `demos/ad_hoc_bytes_wave1_core_type_demo.sifr`
  - `demos/ad_hoc_bytes_wave1_iteration_and_equality_demo.sifr`
