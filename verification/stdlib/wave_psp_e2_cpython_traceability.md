...
- Wave ownership:
  ...
  - `wave_psp_struct_3` for `uuid` typed generation/namespace expansion (completed).
- Closed in continuation:
  ...
  - CPython-derived continuation fixture: `crates/sifr/tests/e2e/pass/phase_psp_struct_3_uuid_datetime_expansion.sifr`
