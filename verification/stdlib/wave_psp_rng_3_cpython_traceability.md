...
| `HtmlTests.test_unescape` numeric references (`&#39;`, `&#x27;`, `&#60;`, `&#x3C;`) | `html.unescape` decodes named entities plus the shipped numeric-reference subset used by top-level helper tests | `lib/sifr/html.sifr`, `crates/sifr_codegen/src/intrinsics/html.rs`, `crates/sifr/tests/e2e/pass/cpython_rng_phase_additional_subset.sifr` | covered |
