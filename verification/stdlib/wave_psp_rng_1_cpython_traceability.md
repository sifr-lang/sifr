...
| --- | --- | --- | --- |
| `TestBasicOps.test_saverestore` | deterministic sequence replay through `getstate`/`setstate` | `crates/sifr/tests/e2e/pass/phase_psp_rng_1_stateful_random_object_model.sifr`, `demos/random_state/main.sifr` | covered |
