...
Lock public contracts, permanent waivers, and CPython-family mapping for the structured-data/class-surface continuation phase before feature-expansion waves begin.

## Locked Public Contract Snapshot

| Module | Locked direction for this phase |
| --- | --- |
...
| `datetime` | Fixed-offset timezone only in this phase; no zone database / DST / `fold`; `timezone` remains the only timezone implementation. |
...
- JSON wrapper-model demo: `demos/ad_hoc_struct_wave0_json_wrapper_model_demo.sifr`
- Fixed-offset datetime-model demo: `demos/ad_hoc_struct_wave0_fixed_offset_datetime_model_demo.sifr`
