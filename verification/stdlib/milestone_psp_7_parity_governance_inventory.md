...
| `bytes` (first-class immutable surface) | `intentional-diff` | `verification/stdlib/wave_psp_a2_cpython_traceability.md`, `verification/stdlib/wave_psp_bytes_0_cpython_traceability.md`, `verification/stdlib/wave_psp_bytes_1_cpython_traceability.md`, `verification/stdlib/wave_psp_bytes_2_cpython_traceability.md`, `verification/stdlib/wave_psp_bytes_3_cpython_traceability.md`, `verification/stdlib/wave_psp_bytes_4_cpython_traceability.md`, `verification/stdlib/wave_psp_bytes_5_cpython_traceability.md` | Immutable first-class `bytes` is now shipped and uses raw-byte backend storage; remaining intentional diffs are narrowed to deferred `bytearray`/`memoryview`/buffer-protocol and non-UTF-8 codec families. |
...
| `base64` | `wave_psp_c2 + wave_psp_rng_2` | `parity-closed` | `verification/stdlib/wave_psp_c2_cpython_traceability.md`, `verification/stdlib/wave_psp_rng_2_cpython_traceability.md` |
...
| `csv` | `wave_psp_c1 + wave_psp_struct_1` | `parity-closed` | `verification/stdlib/wave_psp_c1_cpython_traceability.md` |
| `datetime` | `wave_psp_e1 + wave_psp_struct_3` | `parity-closed` | `verification/stdlib/wave_psp_e1_cpython_traceability.md` |
...
| `wave_psp_a2` | `verification/stdlib/wave_psp_a2_cpython_traceability.md` | Core object-model closure via adapted semantics; historical `bytes` unsupported classification is now superseded by `wave_psp_bytes_1`/`wave_psp_bytes_2`/`wave_psp_bytes_3`. |
...
| `wave_psp_b2` | `verification/stdlib/wave_psp_b2_cpython_traceability.md` | Iterator/functional/random closure; core protocol plus approved itertools combinators are iterator-returning, with only narrow residual waivers for non-closed families. |
...
| `wave_psp_struct_0` | `verification/stdlib/phase_psp_struct_architecture_lock.md`, `issues/ad-hoc-structured-data-and-class-surface-parity-expansion-execution.md` | Architecture lock for structured-data/class-surface continuation, including permanent-diff enforcement fixtures and CPython family wave mapping. |
| `wave_psp_struct_1` | `issues/ad-hoc-structured-data-and-class-surface-parity-expansion-execution.md`, `verification/stdlib/wave_psp_c1_cpython_traceability.md` | Parser/serialization class-surface expansion for `json`, `configparser`, and `csv` under bounded typed wrapper/registry contracts. |
...
| `wave_psp_bytes_1` | `issues/ad-hoc-first-class-bytes-and-binary-surface-foundation-execution.md`, `verification/stdlib/wave_psp_bytes_1_cpython_traceability.md` | First-class immutable `bytes` type-system/HIR/lowering/codegen foundation landed, including bytes literals, indexing/slicing/iteration/equality/concat, and stdlib signature migration baselines. |
| `wave_psp_bytes_2` | `issues/ad-hoc-first-class-bytes-and-binary-surface-foundation-execution.md`, `verification/stdlib/wave_psp_bytes_2_cpython_traceability.md` | Typed conversion surfaces (`bytes(size)`, `bytes.from_ints`, `bytes.from_hex`, `str.encode`, `bytes.decode`) landed with UTF-8-only enforcement and compatibility delegation. |
