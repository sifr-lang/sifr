...
| 31.7 | Ad Hoc Semantic Diagnostic Code Taxonomy and Structured HIR Diagnostics | in_progress | [issues/ad-hoc-semantic-diagnostic-code-taxonomy-and-structured-hir-diagnostics.md](../issues/ad-hoc-semantic-diagnostic-code-taxonomy-and-structured-hir-diagnostics.md) | Corrective Phase 27 addendum replacing phase-derived diagnostic buckets with `SIFR-<FAMILY>-dddd`, shared `sifr_diagnostics`, structured HIR diagnostics, canonical renderers, and guardrails. |
