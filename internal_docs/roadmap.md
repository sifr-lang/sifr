...
| 37.1 | Ad Hoc Sifr Self Update | draft | [issues/ad-hoc-sifr-self-update.md](../issues/ad-hoc-sifr-self-update.md), [issues/ad-hoc-sifr-self-update-execution.md](../issues/ad-hoc-sifr-self-update-execution.md) | CLI-native standalone self-update that resolves immutable installers, preserves installer-owned checksum validation, and keeps stable-channel updates gated until Phase 39. |
