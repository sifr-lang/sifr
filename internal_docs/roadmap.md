...
|---|---|---|---|---|
| 32 | Async and Ecosystem Foundation | in_progress | [32_async_ecosystem.md](./phases/32_async_ecosystem.md) | Async runtime and ecosystem primitives; milestone_async_1 is complete and milestone_async_2 runtime bootstrap, async-result entrypoints, `task.sleep`, task-scope container, conservative `scope.spawn`, task-handle join, direct task-handle await, affine task-handle observation, and task cancellation are underway |
