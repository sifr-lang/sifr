...
| 32.1 | Ad Hoc Async Effect And Offload Diagnostics | proposed | [issues/ad-hoc-async-effect-and-offload-diagnostics.md](../issues/ad-hoc-async-effect-and-offload-diagnostics.md), [issues/ad-hoc-async-effect-and-offload-diagnostics-execution.md](../issues/ad-hoc-async-effect-and-offload-diagnostics-execution.md) | Corrective Phase 32 seal: async functions and awaits must have real suspension effects, direct annotated blocking/CPU-heavy calls in async code become errors, and blocking offload requires classified `@io_bound`, `@cpu_bound`, stdlib-known, or external-contract-known work. |
