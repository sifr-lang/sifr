...
| 36.4 | Ad Hoc Production Concurrency Runtime Platform Substrate | in_progress | [issues/ad-hoc-production-concurrency-runtime-platform-substrate.md](../issues/ad-hoc-production-concurrency-runtime-platform-substrate.md), [issues/ad-hoc-production-concurrency-runtime-platform-substrate-execution.md](../issues/ad-hoc-production-concurrency-runtime-platform-substrate-execution.md) | M0-M6 are complete through typed IPC substrate closeout; M7 integration, docs, demos, validation, waiver, and rejected-surface production gate remains pending. |
