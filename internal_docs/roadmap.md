...
| 36 | Production Developer Tooling and Editor Ecosystem | in_progress | [36_developer_tooling_and_ecosystem_hooks.md](./phases/36_developer_tooling_and_ecosystem_hooks.md) | m36.1 contract lock active: native LSP, formatter/linter policy surfaces, packageable VS Code extension, multi-editor assets, and anti-split-brain tooling validation |
