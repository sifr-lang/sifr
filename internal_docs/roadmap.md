...
| 36.5 | Ad Hoc Production Network and HTTP Platform Substrate | in_progress | [issues/ad-hoc-production-network-http-platform-substrate.md](../issues/ad-hoc-production-network-http-platform-substrate.md), [issues/ad-hoc-production-network-http-platform-substrate-execution.md](../issues/ad-hoc-production-network-http-platform-substrate-execution.md), [network_http_architecture.md](./network_http_architecture.md) | Production `sifr.net`, `sifr.tls`, `sifr.url`, and `sifr.http` substrate is in M5 closeout after M0-M4 merges; Phase 41 may consume protocol/runtime substrate only after final review and merge-gate validation, while multi-core serving throughput stays deferred to the serving-scale follow-up. |
