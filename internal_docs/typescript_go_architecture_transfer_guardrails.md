...
| CLI check/package command reads | `crates/sifr/src/check_and_package_commands.rs:409`, `crates/sifr/src/check_and_package_commands.rs:415`, `crates/sifr/src/check_and_package_commands.rs:427`, `crates/sifr/src/check_and_package_commands.rs:551`, `crates/sifr/src/check_and_package_commands.rs:554`, `crates/sifr/src/check_and_package_commands.rs:587`, `crates/sifr/src/check_and_package_commands.rs:583`, `crates/sifr/src/check_and_package_commands.rs:590`, `crates/sifr/src/check_and_package_commands.rs:601`, `crates/sifr/src/check_and_package_commands.rs:658`, `crates/sifr/src/check_and_package_commands.rs:663`, `crates/sifr/src/check_and_package_commands.rs:797` | CLI package/check command surfaces probe targets and cache paths and read package sources for command output. | Provider-backed for semantic source reads; command-output/cache probes remain documented exceptions where non-semantic. |
| Package Python certification reads | `crates/sifr/src/package_python_certifications.rs:14`, `crates/sifr/src/python_cli.rs:196`, `crates/sifr_package/src/python/arrow_certification.rs:162` | Arrow certification activation and authoring probe the package-root artifact and reject non-regular or symlinked executable fixtures before hashing or execution. | Package certification and archive identity inputs; keep inventoried until a package-aware metadata snapshot owns certification artifact and fixture state. |
