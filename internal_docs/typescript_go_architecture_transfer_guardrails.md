...
| Package Python certification reads | `crates/sifr/src/package_python_certifications.rs:15`, `crates/sifr/src/python_cli.rs:612`, `crates/sifr/src/python_cli.rs:669`, `crates/sifr_package/src/python/arrow_certification.rs:192` | Arrow certification activation and authoring probe the package-root artifact and reject non-regular or symlinked executable fixtures before hashing or execution. | Package certification and archive identity inputs; keep inventoried until a package-aware metadata snapshot owns certification artifact and fixture state. |
