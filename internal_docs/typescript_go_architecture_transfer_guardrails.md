...
The SQLx offline preflight's current package-source and metadata probes are
`crates/sifr_driver/src/build/rust_interop_sqlx_offline.rs:15`,
`crates/sifr_driver/src/build/rust_interop_sqlx_offline.rs:34`,
`crates/sifr_driver/src/build/rust_interop_sqlx_offline.rs:40`,
`crates/sifr_driver/src/build/rust_interop_sqlx_offline.rs:69`,
`crates/sifr_driver/src/build/rust_interop_sqlx_offline.rs:78`, and
`crates/sifr_driver/src/build/rust_interop_sqlx_offline.rs:109`. These are
package build-identity inputs, not semantic Sifr source reads, and remain in
the bridge/probe inventory until a package-aware snapshot owns SQLx metadata.
