...
| Package Python bridge inventory | `crates/sifr_package/src/python/bridge_inventory/filesystem.rs:72`, `crates/sifr_package/src/python/bridge_inventory/filesystem.rs:125`, `crates/sifr_package/src/python/bridge_inventory/mod.rs:194` | Bridge discovery enumerates the fixed package-owned source root, descends package directories, and validates the generated archive inventory. | Package implementation and archive identity inputs; keep inventoried until a package-aware source snapshot owns bridge discovery and generated inventory validation. |
