...
| Driver Rust interop bridge/probe metadata | `crates/sifr_driver/src/build/rust_interop.rs:759`, `crates/sifr_driver/src/build/rust_interop.rs:763`, `crates/sifr_driver/src/build/rust_interop.rs:771`, `crates/sifr_driver/src/build/rust_interop_cargo_inputs.rs:73`, `crates/sifr_driver/src/build/rust_interop_cargo_inputs.rs:78`, `crates/sifr_driver/src/build/rust_interop_cargo_inputs.rs:85`, `crates/sifr_driver/src/build/rust_interop_cargo_inputs.rs:226`, `crates/sifr_driver/src/build/rust_interop_cargo_inputs.rs:236`, `crates/sifr_driver/src/build/rust_interop_cargo_inputs.rs:274`, `crates/sifr_driver/src/build/rust_interop_digest.rs:43`, `crates/sifr_driver/src/build/rust_interop_digest.rs:49`, `crates/sifr_driver/src/build/rust_interop_probe.rs:30` | Rust interop scans declared bridge roots for unsafe bridge files and shared-bridge generated-type imports, hashes bridge/Cargo cache inputs, reads Cargo profile settings, and probes resolved backend Cargo manifests before final build. | Package Rust interop build identity and trust-evidence probes; keep inventoried until a package-aware build snapshot owns bridge source, Cargo profile, shared-bridge boundary, and probe inputs. |
