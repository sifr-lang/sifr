...
| Driver Rust interop bridge/probe metadata | `crates/sifr_driver/src/build/rust_interop.rs:612`, `crates/sifr_driver/src/build/rust_interop.rs:616`, `crates/sifr_driver/src/build/rust_interop.rs:624`, `crates/sifr_driver/src/build/rust_interop.rs:724`, `crates/sifr_driver/src/build/rust_interop.rs:734`, `crates/sifr_driver/src/build/rust_interop.rs:772`, `crates/sifr_driver/src/build/rust_interop_digest.rs:43`, `crates/sifr_driver/src/build/rust_interop_digest.rs:49`, `crates/sifr_driver/src/build/rust_interop_probe.rs:27` | Rust interop scans declared bridge roots for unsafe bridge files, hashes bridge/Cargo cache inputs, and probes resolved backend Cargo manifests before final build. | Package Rust interop build identity and trust-evidence probes; keep inventoried until a package-aware build snapshot owns bridge source, Cargo profile, and probe inputs. |
