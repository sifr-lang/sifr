...
| PostgreSQL parser build adapter | [`cc`](https://docs.rs/cc/) | The component build compiles only the selected checked-in `libpg_query` source. This is build tooling, not a Sifr standard-library API. |
