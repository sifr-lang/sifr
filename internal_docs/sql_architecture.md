...
feature enables the standard exception encoding used by WASI SDK `33` output.
...
| WASI SDK | `33` | [`wasi-sdk` releases](https://github.com/WebAssembly/wasi-sdk/releases/tag/wasi-sdk-33) |
...
sandboxed WebAssembly artifact. It uses WASI SDK `33.0` only as a build
...
workspace member. External provider tools use a validated workspace wrapper.
