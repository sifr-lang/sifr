...
The stdlib host rules and intrinsic registry now live in `sifr_stdlib_model`; this
...
- [ ] Stdlib signature, source inventory, or generated dependency policy changes stay in `sifr_stdlib_model` and pass dependency-direction guardrails.
