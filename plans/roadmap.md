...
| 39.2 | Ad Hoc Stdlib and Compiler Boundary Rearchitecture | research complete, implementation planned | [ad-hoc-stdlib-compiler-boundary-rearchitecture.md](issues/active/ad-hoc-stdlib-compiler-boundary-rearchitecture.md) | Establish the final boundary architecture by migrating runtime diagnostics, removing E2E dependency masking, replacing raw-name intrinsic dispatch with typed HIR identity, deleting dead Counter/legacy defaultdict paths, removing all fallback signature architecture, and recertifying the sysroot boundary. |
