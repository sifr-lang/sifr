...
| 39.1 | Ad Hoc Sifr Sysroot and Stdlib Toolchain | in_progress | [plans/issues/active/ad-hoc-sifr-sysroot-stdlib-toolchain.md](issues/active/ad-hoc-sifr-sysroot-stdlib-toolchain.md), [sifr_sysroot_and_stdlib_architecture.md](../internal_docs/sifr_sysroot_and_stdlib_architecture.md) | Versioned sysroot-backed toolchain migration, generated-program `sifr_stdlib` crate split, sysroot-vendored Sifr-owned dependencies, CLI/LSP sysroot source unification, and Rust interop-backed stdlib native migration. M0 baseline/inventory is open in [PR #2741](https://github.com/sifr-lang/sifr/pull/2741) with local create-pr validation and Opus review satisfied. |
