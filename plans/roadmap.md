...
| GENC-NAN | Ad Hoc Generated NaN Constant Clippy Quality | active, non-blocking | [adhoc_generated_nan_constant_clippy_quality.md](./phases/adhoc_generated_nan_constant_clippy_quality.md) | Keep the complete generated-code suite blocking in nightly while release requires the exact `clippy::zero_divided_by_zero` failure through an indexed divergence expiring 2026-10-31; restore canonical non-finite constants and remove the divergence. |
