...
**B2 (fixtures)**: 5 JSON fixtures now present (basic_module, class_and_methods, control_flow_match, collections_and_generics, async_and_error_handling). `check_ruff_fork_update_rules.py` now requires ≥5.
