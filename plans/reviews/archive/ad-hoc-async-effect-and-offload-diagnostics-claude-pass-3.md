...
- `reviews/ad-hoc-async-effect-and-offload-diagnostics-claude-pass-2.md` (prior review)
...
| `reviews/ad-hoc-async-effect-and-offload-diagnostics-claude-pass-2.md` | Corrected stale diagnostic code table entries for `SIFR-ASYNC-0003` and `SIFR-ASYNC-0004` |
