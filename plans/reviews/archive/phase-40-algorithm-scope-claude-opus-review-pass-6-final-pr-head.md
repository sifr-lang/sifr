...
**1. `plans/reviews/archive/phase-40-algorithm-scope-claude-opus-review-pass-5-pr-head.md` — the mutation table's last row falsely credits `coverage_matrix.py` with catching the nightly under-declaration, and the closing sentence generalizes from it.**
