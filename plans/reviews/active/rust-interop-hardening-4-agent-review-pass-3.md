...
2. **Stray untracked artifact**: `plans/reviews/active/rust-interop-hardening-4-agent-review-pass-3.md` is 0 bytes in the working tree. Not in the PR; delete it rather than committing an empty review file.
