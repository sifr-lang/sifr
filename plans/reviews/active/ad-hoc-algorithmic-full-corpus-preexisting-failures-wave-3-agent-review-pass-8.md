...
- `plans/reviews/active/...wave-3-agent-review-pass-8.md` is present as a zero-byte untracked file; consistent with prior practice it should not be committed empty.
