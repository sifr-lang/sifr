...
9. **Housekeeping:** `plans/reviews/active/…-wave-3-agent-review-pass-4.md` is present and zero bytes (recurring pass-1 §7 / pass-3 §7). I left it untouched per the no-write constraint.
