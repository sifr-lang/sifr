...
- Normal agent invocations with `agent --model agent --effort xhigh --print ...` hung without output across multiple attempts and were interrupted.
...
- No agent findings were produced for this round.
