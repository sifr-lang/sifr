...
`e75af095` is the merge of PR #41 whose reviewed head `4fdb439` returned SATISFIED at corpus review pass 2 (`plans/reviews/active/…rotate-corpus-pr-41-agent-review-pass-2.md`). The pin is exact.
