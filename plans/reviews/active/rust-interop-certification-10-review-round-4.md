...
Artifact convention holds: only `.md` files are committed (rounds 1–3); the 0-byte `.agent.log` and the round-4 placeholders remain untracked, matching the certification_9 precedent.
