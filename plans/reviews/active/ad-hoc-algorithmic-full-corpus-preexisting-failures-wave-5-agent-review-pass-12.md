...
**1. `plans/reviews/active/…wave-5-agent-review-pass-11.md` (+88, new file)**
...
- Link target `../../reviews/active/…wave-5-agent-review-pass-11.md` resolves from `plans/issues/active/` to the file added in the same commit. ✓
...
- Line 330 is a single well-formed table row; the pass-11 entry follows the same `[agent pass N](…)` pattern as passes 1–10. No other section of the document required updating for this delta (the Wave 5 narrative at lines 279–303 is status-neutral).
