...
7. **Housekeeping before the PR:** untracked `_probe3/` scratch dir (26 `.sifr` files) is still in the tree, plus zero-byte `…wave-3-…-pass-2.claude.log`, `pass-3.claude.log`, and `pass-3.md` (pass-1 §7 recurring).
