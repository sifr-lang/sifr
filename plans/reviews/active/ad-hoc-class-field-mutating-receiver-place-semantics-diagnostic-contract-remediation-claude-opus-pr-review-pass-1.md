...
(The `plans/reviews/active/…diagnostic-contract-remediation-claude-opus-pr-review-pass-1.md` placeholder is present and zero-byte; that is the slot for this review, not a finding.)
