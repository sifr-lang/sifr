...
- `plans/reviews/active/ad-hoc-algorithmic-full-corpus-preexisting-failures-wave-2-agent-review-pass-1.md` is currently a 0-byte untracked placeholder — noting only so it isn't committed empty.
