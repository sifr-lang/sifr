...
7. **Zero-byte review artifact in the tree.** `plans/reviews/active/ad-hoc-algorithmic-full-corpus-preexisting-failures-wave-3-claude-opus-review-pass-1.md` is 0 bytes and untracked. Remove or populate before the PR.
