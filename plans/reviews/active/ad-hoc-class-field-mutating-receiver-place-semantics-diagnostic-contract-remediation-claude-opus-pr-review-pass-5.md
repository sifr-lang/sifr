...
2. `plans/reviews/active/…-diagnostic-contract-remediation-claude-opus-pr-review-pass-5.md` exists locally as an untracked **0-byte** placeholder. Not in the PR, not in the reviewed head.
