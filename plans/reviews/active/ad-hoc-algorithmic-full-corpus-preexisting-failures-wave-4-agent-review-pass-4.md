...
- **N5** — `plans/reviews/active/…-wave-4-agent-review-pass-4.md` and its `.agent.log` exist as zero-byte artifacts from the timed-out run; they should be discarded or overwritten rather than left as apparent evidence.
