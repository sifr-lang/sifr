...
- **Precedent parity**: `presentation_contract_cases` already establishes the `synthetic=true` pattern — fabricated stderr, identical normalizers, identical bless-reference scheme. The new fixture is a faithful replication.
