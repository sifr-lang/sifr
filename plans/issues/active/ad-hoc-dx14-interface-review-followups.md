...
| --- | --- | --- |
| DX14-F1 | Captured observation storage | Resolved by [DXF.2 / #3877](https://github.com/sifr-lang/sifr/pull/3877): distinct facts retain first-occurrence order and absence/conflicting outcomes; 16384-fact overflow declines publication. Fresh-oracle and persistence regressions pass. Conservative rejected-candidate fact capture remains a nonblocking optimization follow-up. |
| DX14-F2 | Historical project-record lookup | Resolved by [DXF.2 / #3877](https://github.com/sifr-lang/sifr/pull/3877): cheap filtering precedes at most one existing proof; 4097-publication retained-cap measurements and unrelated-candidate regressions pass. Full retained-manifest validation remains explicit cost; no constant-total-I/O claim. |
...
| DX14-F4 | Phase-end lint qualification | Review noted a possible clippy::let_and_return shape in manifestless_inputs, not a measured failure. Closed for the affected default-feature Rust 1.98.1 driver targets by [strict lint reconciliation #3895](https://github.com/sifr-lang/sifr/pull/3895); no warning was observed for this expression. The bounded evidence and unrelated integration-target limitation are recorded in the [DXF.3 lint closure](ad-hoc-dxf3-housekeeping-review-followups.md#merged-lint-record--2026-09-21-europestockholm). |
