...
| M10. Signal Callback and Subscription Pilot | in progress | PR #2892 · sha=4a5b16c · M10a signal native boundary migrated `_sifr.signal` through private Rust interop and `sifr_stdlib::signals`; retained compiler signal registry/source removed; `create-pr` lane passed locally with warm wall-time advisory only; Opus review satisfied in round 6 |
