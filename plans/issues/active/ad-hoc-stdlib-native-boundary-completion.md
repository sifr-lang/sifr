...
| M7. Process Family | in progress | PR #2877 · sha=de07b23 · M7a sync process output migrated through `_sifr.process` and `sifr_stdlib::process`; M7b sync child/pipe migration ready for PR · review READY: `plans/reviews/active/m7b-sync-process-child-pipes-opus-round1.md` |
...
- M7b: migrate synchronous child lifecycle and pipe leaves through
  ...
  leaves retained for later M7 slices. Focused sync child/pipe tests, selected
  grouped E2E, and migration guardrails passed; reviewer round 1 is READY.
