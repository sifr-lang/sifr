...
| M3. File and Filesystem Migration | in progress | PR #2851 · sha=12b64b4; PR #2852 · sha=72a62f1; PR #2853 |
...
- Implement file behavior and Sifr-facing errors in `crates/sifr_stdlib`.
  - M3b migrates the non-handle text helper subset (`read_text`, `write_text`,
    ...
    in PR #2853; local `create-pr` validation passed with no advisories and
    reviewer pass 4 READY.
