...
- Status: formatter compact baseline expansion implemented, locally merge-gate validated, reviewed with no blockers, and open in PR [#2582](https://github.com/sifr-lang/sifr/pull/2582).
