...
- Status: stdlib unsupported-surface compact baseline expansion implemented, focused-validated, reviewed with no blockers, create-pr validated, merge-gate validated, and open as PR https://github.com/sifr-lang/sifr/pull/2586.
