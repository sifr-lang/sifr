...
- Status: text I/O and encoding compact baseline expansion implemented, locally focused-validated, reviewed with no blockers, create-pr validated, merge-gate validated, and pending PR.
