...
- Status: self-update missing-receipt compact baseline expansion implemented, locally merge-gate validated, reviewed with no blockers, and opened in PR [#2588](https://github.com/sifr-lang/sifr/pull/2588).
