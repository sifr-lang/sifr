...
Status: in progress; Wave 0, Wave 1, Wave 2.0, Wave 2.1, Wave 2.2, Wave 2.3, Wave 2.4, Wave 2.5, Wave 2.final, Wave 3, Wave 4 diagnostic-baseline slices through final BUILD/STDLIB/legacy-WORKSPACE synthetic-baseline coverage, Wave 5.1 parsed-source shape inventory, and Wave 5.2 HIR-lowering snapshots merged in PR [#2623](https://github.com/sifr-lang/sifr/pull/2623); Wave 5.3 name-resolution snapshots in progress on branch `codex/wave-5-3-name-resolution-snapshots`
...
- Status: in progress on branch `codex/wave-5-3-name-resolution-snapshots`.
