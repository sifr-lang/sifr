...
canonical suite and a complete native build/run audit, and closeout restores
the full corpus plus taxonomy self-test to release qualification. The temporary
release-profile divergence is removed rather than renewed.
