...
The required trace-artifact blocker has its [own issue](ad-hoc-dx-trace-artifact-remediation.md).
...
| Documentation | Explain prune reserve-bytes and prune-project; reconcile stale profile examples and historical source-migration prose during closure. |
...
The baseline-era Target commands and acceptance preamble should be reconciled
truthfully on resumed closure, preserving required unimplemented capabilities
until they are actually satisfied. None of these suggestions waives the blocker.
