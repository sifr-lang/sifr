...
| PR 11 Regression Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2517> |
| PR 12 Fuzz Property Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2519> |
| PR 13 Generated Code Quality Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2521> |
| PR 14 Performance Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2523> |
| PR 15 Developer Tooling Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2525> |
| PR 16 Runtime Platform Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2527> |
| PR 17 Distribution Release Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2529> |
...
| `package_management` | Deleted `verification/package_management/`, `crates/sifr/tests/verification/package/`, and `scripts/check_package_manager_guardrails.py`; moved package data, demo repository corpora, package fixtures, and guardrail tool under the package management area | `verification/areas/package_management/` | `uv run --project verification --locked python -m sifr_verify areas run --area package_management --suite guardrails`; profile facade dispatches package-manager guardrails through this area | Area schema validation and package guardrail equivalence pending this PR | In progress in PR 18 |
