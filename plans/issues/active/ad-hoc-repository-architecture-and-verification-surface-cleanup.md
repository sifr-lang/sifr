...
| PR 19 Stdlib Parity Area Migration | Merged | <https://github.com/sifr-lang/sifr/pull/2533> |
...
| `algorithmic_compatibility` | Moved LeetCode submodule corpus and full-corpus taxonomy script | `verification/areas/algorithmic_compatibility/` | `uv run --project verification --locked python -m sifr_verify areas run --area algorithmic_compatibility --suite taxonomy-smoke`; `--suite leetcode-check` | In progress in implementation PR 20 | Implementation in progress |
