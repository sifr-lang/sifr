...
| M9-M13 | in progress | M9 wave 1 migrates `_sifr.platform` and `_sifr.html` to private Rust interop declarations backed by `sifr_stdlib` features; remaining M9 stateless leaves continue in follow-up waves. |
