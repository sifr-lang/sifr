...
| `cargo test -p sifr --test e2e network_http_dependency_rules_tests -- --nocapture` | PASS | Verifies e2e dependency generation and inference for URL/HTTP primitives and the driver-seeded HTTP transport harness. |
