...
| 8 | Error Safety | 2 (error_safety, error_safety_stdlib_types) | pending | Built-in error classes, exhaustiveness checking on `except` arms, `Result[T, str]` eliminated, module-specific error type export pipeline |
