...
- Every top-level user-facing compiler diagnostic must carry a stable code and deterministic documentation URL of the form `https://sifr.dev/docs/errors/<CODE>`.
