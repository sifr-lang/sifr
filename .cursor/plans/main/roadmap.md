...
| 28 | Decimal Semantics | in_progress | [28_decimal_type_and_exact_numeric_semantics.md](./phases/28_decimal_type_and_exact_numeric_semantics.md) | First-class exact decimal semantics |
