...
| 22 | Frontend Mode Parity Hardening | planned | [22_frontend_mode_parity_hardening.md](./phases/22_frontend_mode_parity_hardening.md) | Canonical frontend parity across `check/build/run/test` |
