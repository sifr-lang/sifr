...
## Quality Contract
- Entry criteria: Phase 32 is completed and tooling contracts are stable.
...
- Validation planning goals:
  - `milestone_33_1` (Package Management): validation goals cover: Dependency declaration, lockfile semantics, resolution workflow. Include negative-path goals that catch regressions against these guarantees.
