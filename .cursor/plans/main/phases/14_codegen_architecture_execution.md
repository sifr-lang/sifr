...
- [x] PR169 slice: continue RawCode-zero gate by replacing intrinsic `RustExpr::RawCode` returns in remaining registry modules (`base32`, `bytes`, `calendar`, `gzip`, `os`, `platform`, `subprocess`, `time`, `toml`, `uuid`, `zipfile`)
