...
Explicitly support returning multiple values as tuples (syntax already works via M2 tuples, but should be tested):
...
- `**isinstance` narrowing for class types:** extends M3's narrowing engine to class instances
