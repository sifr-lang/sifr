...
fn main() {
    ...
    println!(
        ...
        format!(
            "{}{}",
            "gcd(48, 18) = ".to_string(),
            format!("{}", gcd(48 as i64, 18 as i64))
        )
    );
    println!(
        "{}",
    ...
    println!(
        ...
        format!(
            "{}{}",
            "comb(10, 3) = ".to_string(),
            format!("{}", comb(10 as i64, 3 as i64))
        )
    );
    println!(
        "{}",
    ...
    println!(
        ...
        format!(
            "{}{}",
            "isfinite(1.0) = ".to_string(),
            format!("{}", (1.0 as f64).is_finite())
        )
    );
    ...
    let __sifr_try_res: Result<(), StatisticsError> = (|| {
        ...
        println!(
            "{}",
            format!("{}{}", "harmonic_mean = ".to_string(), format!("{}", hm))
        );
        println!(
            "{}",
            format!("{}{}", "median_low = ".to_string(), format!("{}", ml))
        );
        println!(
            "{}",
            format!("{}{}", "median_high = ".to_string(), format!("{}", mh))
        );
        return Ok(());
    })();
    ...
    println!(
        ...
        format!(
            "{}{}",
            "capwords = ".to_string(),
            capwords(&"hello world test".to_string())
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "stem = ".to_string(),
            stem(&"/docs/report.pdf".to_string())
        )
    );
    println!(
        "{}",
        format!(
            ...
            format!("{}", is_absolute(&"/usr/bin".to_string()))
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "bisect_left(floats, 2.5) = ".to_string(),
            format!("{}", bisect_left(&floats, &(2.5 as f64), 0 as i64, None))
        )
    );
    println!("=== Itertools ===");
    ...
    println!(
        ...
        format!(
            ...
            format!(
                "{:?}",
                pairwise(&(items).iter().copied().collect::<Vec<_>>())
            )
        )
    );
    let items2: Vec<i64> = vec![
        1 as i64, 2 as i64, 3 as i64, 4 as i64, 5 as i64, 6 as i64, 7 as i64, 8 as i64,
    ];
    let __sifr_try_res: Result<(), ValueError> = (|| {
        let bat: Vec<Vec<i64>> = batched(&(items2).iter().copied().collect::<Vec<_>>(), 3 as i64)?;
        println!(
            "{}",
            format!("{}{}", "batched = ".to_string(), format!("{:?}", bat))
        );
        return Ok(());
    })();
    if let Err(__sifr_try_err) = __sifr_try_res {
