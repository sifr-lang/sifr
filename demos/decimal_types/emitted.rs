...
fn main() {
    ...
    let d_plus: Decimal = d + Decimal::from(2_i64);
    let b_plus: BigDecimal = ::bigdecimal::Context::default().with_rounding_mode(::bigdecimal::RoundingMode::HalfEven).with_prec(28).unwrap_or_else(|| ::bigdecimal::Context::default().with_rounding_mode(::bigdecimal::RoundingMode::HalfEven)).round_decimal_ref(&(b.clone() + BigDecimal::from(4_i64)));
