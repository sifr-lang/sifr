...
fn classify(n: i64) -> String {
    if n > (0_i64) { "positive".to_string() } else { "non-positive".to_string() }
}
...
fn demo_step_slicing() {
    ...
    let _s = &(s);
    _s.chars().step_by(2_usize).collect::<String>()
});
    println!("Reversed string: {}", {
    let _s = &(s);
    _s.chars().rev().collect::<String>()
});
}
...
fn demo_power() {
    println!("2 ** 10 = {}", SifrInt::from_i64(2).pow((10_i64) as u32));
    println!("3 ** 3 = {}", SifrInt::from_i64(3).pow((3_i64) as u32));
}
...
fn main() {
    ...
    demo_loop_else();
    demo_power();
    let (q, r) = ((17_i64) / (5_i64), (17_i64) % (5_i64));
