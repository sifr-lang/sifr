...
fn demo_step_slicing() {
    let nums: Vec<i64> = vec![
        0 as i64, 1 as i64, 2 as i64, 3 as i64, 4 as i64, 5 as i64, 6 as i64, 7 as i64, 8 as i64,
        9 as i64,
    ];
    let evens: Vec<i64> = {
        let _v = &(nums);
...
fn demo_string_methods() {
    ...
    println!(
        "Replace: {}",
        s.replace(&"world".to_string(), &"Sifr".to_string())
    );
    println!(
        "Starts with \'hello\': {}",
...
fn demo_list_methods() {
    ...
    println!(
        "Count of 1: {}",
        items.iter().filter(|x| **x == (1 as i64)).count() as i64
    );
...
fn demo_dict_methods() {
    let mut d: HashMap<String, i64> = HashMap::from([
...
fn demo_walrus() {
    let items: Vec<i64> = vec![
        1 as i64, 2 as i64, 3 as i64, 4 as i64, 5 as i64, 6 as i64, 7 as i64, 8 as i64, 9 as i64,
        10 as i64,
    ];
