...
fn main() {
    ...
    let d: Decimal =
        Decimal::from_str_exact(("-1.9".to_string()).as_str()).unwrap_or_else(|__e| unreachable!());
    ...
    let __sifr_try_res: Result<(), DecimalConversionError> = (|| {
        let i_from_decimal: i64 = ({
            ...
            i64::try_from(&__decimal_bigint).map_err(|__e_ignored| DecimalConversionError {
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "unexpected conversion failure: ".to_string(),
                e.message
            )
        );
    }
    ...
    let bd_from_decimal: BigDecimal = ((Decimal::from_str_exact(("12.3400".to_string()).as_str())
        .unwrap_or_else(|__e| unreachable!()))
    .to_string())
    .parse::<BigDecimal>()
    .unwrap_or_else(|__e| unreachable!());
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "unexpected decimal conversion failure: ".to_string(),
                e.message
            )
        );
    }
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            "{}",
            format!("{}{}", "caught conversion error: ".to_string(), e.message)
        );
    }
}
