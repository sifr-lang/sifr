...
fn NAMESPACE_DNS() -> SifrGeneratedStdlibSifrX2euuidX2eUUID {
    SifrGeneratedStdlibSifrX2euuidX2eUUID::new("6ba7b810-9dad-11d1-80b4-00c04fd430c8".to_string())
}
    ...
    actual.push(
        {
            ...
            sifr_generated_chars_id_text.get(sifr_generated_string_index_normalized)
        }
        .map(::std::string::ToString::to_string)
            == Some("4".to_string()),
    );
