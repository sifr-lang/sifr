...
fn _collect_iterable<T: Clone + std::fmt::Display + PartialOrd + 'static>(data: Vec<T>) -> Vec<T> {
...
fn accumulate<T: Clone + std::fmt::Display + PartialOrd + 'static + std::ops::Add<Output = T>>(
    data: &Vec<T>,
    initial: Option<T>,
...
fn compress<T: Clone + std::fmt::Display + PartialOrd + 'static>(
    ...
    let data_owned: Vec<T> =
        _collect_iterable(((data).iter().cloned().collect::<Vec<_>>()).clone());
...
fn zip_longest<T: Clone + std::fmt::Display + PartialOrd + 'static>(
    ...
    let a_owned: Vec<T> = _collect_iterable(((a).iter().cloned().collect::<Vec<_>>()).clone());
    let b_owned: Vec<T> = _collect_iterable(((b).iter().cloned().collect::<Vec<_>>()).clone());
...
fn main() {
    ...
    println!(
        ...
        format!(
            "{}{}",
            "isqrt(17) = ".to_string(),
            format!("{}", ((17 as i64) as f64).sqrt() as i64)
        )
    );
    ...
    let data_fsum: Vec<f64> = vec![
        0.1 as f64, 0.1 as f64, 0.1 as f64, 0.1 as f64, 0.1 as f64, 0.1 as f64, 0.1 as f64,
        0.1 as f64, 0.1 as f64, 0.1 as f64,
    ];
    println!(
        "{}",
        format!(
            "{}{}",
            "fsum(10x0.1) = ".to_string(),
            format!("{}", {
                ...
                if __has_nan || (__pos_inf && __neg_inf) {
                    f64::NAN
                } else {
                    if __pos_inf {
                        f64::INFINITY
    ...
    let __sifr_try_res: Result<(), StatisticsError> = (|| {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "multimode len = ".to_string(),
                format!("{}", mm.len() as i64)
            )
        );
        ...
        println!(
            ...
            format!(
                "{}{}",
                "quartiles count = ".to_string(),
                format!("{}", qs.len() as i64)
            )
        );
        ...
        println!(
            "{}",
            format!("{}{}", "covariance = ".to_string(), format!("{}", cov))
        );
        let r: f64 = correlation(&x, &y)?;
        println!(
            "{}",
            format!("{}{}", "correlation = ".to_string(), format!("{}", r))
        );
        ...
        if let Some(slope) = slope {
            println!(
                "{}",
                format!("{}{}", "slope = ".to_string(), format!("{}", slope))
            );
        }
        if let Some(intercept) = intercept {
            println!(
                "{}",
                format!("{}{}", "intercept = ".to_string(), format!("{}", intercept))
            );
        }
        return Ok(());
    })();
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            "{}",
            format!("{}{}", "empty mean error: ".to_string(), e.message)
        );
    }
    ...
    println!(
        ...
        format!(
            "{}{}",
            "shuffle len = ".to_string(),
            format!("{}", items.len() as i64)
        )
    );
    let __sifr_try_res: Result<(), ValueError> = (|| {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "sample(3) len = ".to_string(),
                format!("{}", s3.len() as i64)
            )
        );
        return Ok(());
    })();
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            "{}",
            format!("{}{}", "sample error: ".to_string(), e.message)
        );
    }
    let __sifr_try_res: Result<(), ValueError> = (|| {
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            "{}",
            format!("{}{}", "randrange error: ".to_string(), e.message)
        );
    }
    ...
    println!(
        "{}",
        format!("{}{}", "reduce(add) = ".to_string(), format!("{}", total))
    );
    ...
    println!(
        "{}",
        format!("{}{}", "reduce(mul) = ".to_string(), format!("{}", product))
    );
    println!("=== itertools additions ===");
    let idata2: Vec<i64> = vec![1 as i64, 2 as i64, 3 as i64, 4 as i64, 5 as i64];
    let acc: Vec<i64> =
        accumulate(&(idata2).iter().copied().collect::<Vec<_>>(), None).collect::<Vec<_>>();
    println!(
        "{}",
        format!("{}{}", "accumulate = ".to_string(), format!("{:?}", acc))
    );
    ...
    println!(
        "{}",
        format!("{}{}", "compress = ".to_string(), format!("{:?}", comp))
    );
    ...
    println!(
        "{}",
        format!("{}{}", "dropwhile(<3) = ".to_string(), format!("{:?}", dw))
    );
    ...
    println!(
        "{}",
        format!("{}{}", "takewhile(<3) = ".to_string(), format!("{:?}", tw))
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "zip_longest len = ".to_string(),
            format!("{}", zl.len() as i64)
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "count(0,2) first 5 = ".to_string(),
            format!("{:?}", vec![c0, c1, c2, c3, c4])
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "cycle([1,2,3], 7) = ".to_string(),
            format!("{:?}", cyc)
        )
    );
    println!("=== Counter enhancements ===");
    let mut c1 = from_list(&vec![
        "a".to_string(),
        "b".to_string(),
        "a".to_string(),
        "c".to_string(),
    ...
    println!(
        ...
        format!(
            "{}{}{}{}",
            "after update: a=".to_string(),
            format!("{}", c1.get(&"a".to_string(), 0 as i64)),
            " b=".to_string(),
            format!("{}", c1.get(&"b".to_string(), 0 as i64))
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "after subtract: x=".to_string(),
            format!("{}", c3.get(&"x".to_string(), 0 as i64))
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "counter_add b = ".to_string(),
            format!("{}", cc.get(&"b".to_string(), 0 as i64))
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "counter_sub a = ".to_string(),
            format!("{}", cd.get(&"a".to_string(), 0 as i64))
        )
    );
