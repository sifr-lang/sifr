...
mod sifr_generated_project_nominals {
    ...
    impl SifrGeneratedStdlibSifrX2etomllibX2eTomlValue {
        #[must_use]
        pub fn as_array(&self) -> Option<Vec<SifrGeneratedStdlibSifrX2etomllibX2eTomlValue>> {
            if !self.is_array() {
                return None;
            }
    ...
    impl SifrGeneratedStdlibSifrX2etomllibX2eTomlValue {
        ...
        pub fn as_table(
            &self,
        ) -> Option<Vec<(String, SifrGeneratedStdlibSifrX2etomllibX2eTomlValue)>> {
            if !self.is_table() {
                return None;
            }
    ...
    impl SifrGeneratedStdlibSifrX2etomllibX2eTomlValue {
        #[must_use]
        pub fn values(&self) -> Vec<SifrGeneratedStdlibSifrX2etomllibX2eTomlValue> {
            let mut result: Vec<SifrGeneratedStdlibSifrX2etomllibX2eTomlValue> = Vec::new();
            if !self.is_table() {
                return result;
            }
    ...
    impl SifrGeneratedStdlibSifrX2etomllibX2eTomlValue {
        #[must_use]
        pub fn items(&self) -> Vec<(String, SifrGeneratedStdlibSifrX2etomllibX2eTomlValue)> {
            if !self.is_table() {
                return Vec::new();
            }
            let mut result: Vec<(String, SifrGeneratedStdlibSifrX2etomllibX2eTomlValue)> =
...
#[derive(Debug, Clone)]
pub enum SifrGeneratedUnion8X3asequence5X3aunion1X3a223X3a5X3aclass10X3aParseError1X3a028X3a5X3aclass15X3aTOMLDecodeError1X3a0
{
...
///# Errors
///Returns the typed error produced by this operation.
pub fn sifr_generated_token_at(
    tokens: &[String],
    index: SifrInt,
...
///# Errors
///Returns the typed error produced by this operation.
pub fn sifr_generated_token_int(
    tokens: &[String],
    index: SifrInt,
...
///# Errors
///Returns the typed error produced by this operation.
pub fn sifr_generated_token_float(
    tokens: &[String],
    index: SifrInt,
...
///# Errors
///Returns the typed error produced by this operation.
pub fn sifr_generated_decode_bool_token(value: &str) -> Result<bool, TOMLDecodeError> {
    if value == "true" {
        return Ok(true);
    }
    if value == "false" {
...
pub fn sifr_generated_decode_toml_value_at(
    tokens: &[String],
    index: SifrInt,
...
///# Errors
///Returns the typed error produced by this operation.
pub fn sifr_generated_decode_toml_tokens(
    tokens: &[String],
...
///# Errors
///Returns the typed error produced by this operation.
pub fn loads(text: &str) -> Result<SifrGeneratedStdlibSifrX2etomllibX2eTomlValue, TOMLDecodeError> {
    let sifr_generated_try_res: Result<
        Result<SifrGeneratedStdlibSifrX2etomllibX2eTomlValue, TOMLDecodeError>,
        ParseError,
    > = (|| {
