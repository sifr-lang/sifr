...
fn main() {
    ...
    let origin: Point = Point::new(SifrInt::from_i64(0), SifrInt::from_i64(0));
    let horizontal_point: Point = Point::new(SifrInt::from_i64(3), SifrInt::from_i64(0));
    let vertical_point: Point = Point::new(SifrInt::from_i64(0), SifrInt::from_i64(4));
    let diagonal_point: Point = Point::new(SifrInt::from_i64(3), SifrInt::from_i64(4));
    println!("{}", classify_point(&origin));
    println!("{}", classify_point(&horizontal_point));
    println!("{}", classify_point(&vertical_point));
    println!("{}", classify_point(&diagonal_point));
