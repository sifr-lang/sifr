...
fn demo_math() {
    ...
    let __poly: f64 = __t * (0.254829592 + (__t * (-0.284496736 + (__t * (1.421413741 + (__t * (-1.453152027 + (__t * 1.061405429))))))));
    let __r: f64 = 1.0 - (__poly * (-__x * __x).exp());
    if __x >= 0.0 { __r } else { -__r }
};
    println!("{}", format!("{}{}", "erf near 0 = ".to_string(), format!("{}", (e0 < (0.001 as f64)) && (e0 > -(0.001 as f64)))));
    let ec0: f64 = {
    let __x: f64 = (0.0 as f64) as f64;
    let __t: f64 = 1.0 / (1.0 + (0.3275911 * __x.abs()));
    let __poly: f64 = __t * (0.254829592 + (__t * (-0.284496736 + (__t * (1.421413741 + (__t * (-1.453152027 + (__t * 1.061405429))))))));
    let __r: f64 = __poly * (-__x * __x).exp();
    if __x >= 0.0 { __r } else { 2.0 - __r }
};
    println!("{}", format!("{}{}", "erfc near 1 = ".to_string(), format!("{}", (ec0 > (0.999 as f64)) && (ec0 < (1.001 as f64)))));
    let g: f64 = {
    let __x: f64 = (5.0 as f64) as f64;
    let __g: usize = 7 as usize;
    let __c = vec![0.9999999999998099, 676.5203681218851, -1259.1392167224028, 771.3234287776531, -176.6150291621406, 12.507343278686905, -0.13857109526572012, 0.000009984369578019572, 0.00000015056327351493116];
    if (__x <= 0.0) && (__x == __x.floor()) { f64::INFINITY } else { if __x < 0.5 { {
    ...
    let __base: f64 = (((2.0 * std::f64::consts::PI).sqrt() * __t2.powf(__xn - 0.5)) * (0.0 - __t2).exp()) * __s;
    ...
    (((2.0 * std::f64::consts::PI).sqrt() * __t2.powf(__xm + 0.5)) * (0.0 - __t2).exp()) * __s
} } }
};
    println!("{}", format!("{}{}", "gamma(5) > 23 = ".to_string(), format!("{}", g > (23.0 as f64))));
    let lg: f64 = {
    let __x: f64 = (5.0 as f64) as f64;
    let __g: usize = 7;
    let __c = vec![0.9999999999998099, 676.5203681218851, -1259.1392167224028, 771.3234287776531, -176.6150291621406, 12.507343278686905, -0.13857109526572012, 0.000009984369578019572, 0.00000015056327351493116];
    if (__x <= 0.0) && (__x == __x.floor()) { f64::INFINITY } else { {
    ...
    let __t2: f64 = (__xm + (__g as f64)) + 0.5;
    let __r: f64 = (((2.0 * std::f64::consts::PI).sqrt().ln() + ((__xm + 0.5) * __t2.ln())) - __t2) + __s.ln();
    if __x < 0.5 { (std::f64::consts::PI / ((__x * std::f64::consts::PI).sin() * __r.exp())).abs().ln() } else { __r }
} }
};
    println!("{}", format!("{}{}", "lgamma(5) > 3 = ".to_string(), format!("{}", lg > (3.0 as f64))));
    let fp: Vec<f64> = {
    let __x: f64 = (8.0 as f64) as f64;
    if __x == 0.0 { vec![__x, 0.0] } else { if !__x.is_finite() { vec![__x, 0.0] } else { {
    ...
    let __mant: f64 = f64::from_bits((__sign | ((1022 as u64) << 52)) | __sfrac);
    let __e: i32 = (__sexp - 1022) - 54;
    vec![__mant, __e as f64]
} } else { {
    let __mant: f64 = f64::from_bits((__sign | ((1022 as u64) << 52)) | __frac);
    ...
    if let Some(mantissa) = mantissa {
        println!("{}", format!("{}{}", "frexp(8.0) mantissa = ".to_string(), format!("{}", mantissa)));
    }
    let ld: f64 = ((0.5 as f64) as f64) * (2.0 as f64).powi((4 as i64) as i32);
    println!("{}", format!("{}{}", "ldexp(0.5, 4) = ".to_string(), format!("{}", ld)));
    let md: Vec<f64> = {
    let __x: f64 = (3.7 as f64) as f64;
    if __x.is_nan() { vec![f64::NAN, f64::NAN] } else { if __x.is_infinite() { vec![(0.0 as f64).copysign(__x), __x] } else { {
    let __int = __x.trunc();
    ...
    if let Some(frac) = frac {
        println!("{}", format!("{}{}", "modf(3.7) frac > 0 = ".to_string(), format!("{}", frac > (0.0 as f64))));
    }
    let na: f64 = {
    ...
    println!("{}", format!("{}{}", "nextafter(1.0, 2.0) > 1.0 = ".to_string(), format!("{}", na > (1.0 as f64))));
    let u: f64 = {
    let __x: f64 = (1.0 as f64) as f64;
    ...
    println!("{}", format!("{}{}", "ulp(1.0) > 0 = ".to_string(), format!("{}", u > (0.0 as f64))));
}

fn demo_os() {
    println!("=== os new intrinsics ===");
    let pid: i64 = std::process::id() as i64;
    println!("{}", format!("{}{}", "pid > 0 = ".to_string(), format!("{}", pid > (0 as i64))));
    let cpus: i64 = {
    let __n = std::thread::available_parallelism().map(|n| n.get()).unwrap_or(1);
    __n as i64
};
    println!("{}", format!("{}{}", "cpu_count >= 1 = ".to_string(), format!("{}", cpus >= (1 as i64))));
}
...
fn demo_platform() {
    ...
    println!("{}", format!("{}{}", "system len > 0 = ".to_string(), format!("{}", (system().chars().count() as i64) > (0 as i64))));
    println!("{}", format!("{}{}", "machine len > 0 = ".to_string(), format!("{}", (machine().chars().count() as i64) > (0 as i64))));
    println!("{}", format!("{}{}", "processor len > 0 = ".to_string(), format!("{}", (processor().chars().count() as i64) > (0 as i64))));
}

fn demo_time() {
    println!("=== time new intrinsics ===");
    let gmt: struct_time = gmtime_struct(0.0 as f64);
    println!("{}", format!("{}{}", "gmtime year = ".to_string(), format!("{}", gmt.tm_year == (1970 as i64))));
    let lt: struct_time = localtime_struct(0.0 as f64);
    println!("{}", format!("{}{}", "localtime yday >= 1 = ".to_string(), format!("{}", lt.tm_yday >= (1 as i64))));
    ...
    println!("{}", format!("{}{}", "strptime ok = ".to_string(), format!("{}", (parsed.chars().count() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "strptime error: ".to_string(), e.message));
    }
}
...
fn demo_base64() {
    ...
    while __i < __data.len() {
        ...
        let __b1 = if (__i + 1) < __data.len() { __data[__i + 1] as i64 } else { 0 };
        let __b2 = if (__i + 2) < __data.len() { __data[__i + 2] as i64 } else { 0 };
        let __b3 = if (__i + 3) < __data.len() { __data[__i + 3] as i64 } else { 0 };
        let __b4 = if (__i + 4) < __data.len() { __data[__i + 4] as i64 } else { 0 };
        let __buf = ((((__b0 << 32) | (__b1 << 24)) | (__b2 << 16)) | (__b3 << 8)) | __b4;
        let __remaining = __data.len() - __i;
        let __n = if __remaining < 5 { __remaining } else { 5 };
        for __j in 0..8 {
            if __j < (((__n * 8) + 4) / 5) {
                __out.push(__b32_alpha[((__buf >> ((35 - (__j * 5)) as usize)) & 31) as usize] as char);
            } else {
                __out.push('=');
            }
        }
    ...
    println!("{}", format!("{}{}", "b32encode len > 0 = ".to_string(), format!("{}", (encoded.chars().count() as i64) > (0 as i64))));
    ...
    for __c in __s.chars() {
        let __val_opt = __b32_alpha.iter().position(|b| (*b as char) == __c.to_ascii_uppercase());
        let mut __val = 0;
        if let Some(__v) = __val_opt {
            __val = __v as i64;
        } else {
            return Err(ParseError { message: format!("invalid base32 char: {}", __c) });
        }
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "b32decode error: ".to_string(), e.message));
    }
}
...
fn demo_shutil() {
    ...
    if let Some(total) = total {
        println!("{}", format!("{}{}", "disk_total > 0 = ".to_string(), format!("{}", total > (0 as i64))));
    }
}
