...
fn main() {
    ...
    println!("{}", format!("First: {}", nums[0_i64 as usize]));
    println!("{}", format!("Last: {}", nums[4_i64 as usize]));
    let mut total: i64 = 0_i64;
    ...
    println!("{}", format!("Alice is {} years old", ages[&"Alice".to_string()]));
    println!("{}", format!("Bob is {} years old", ages[&"Bob".to_string()]));
