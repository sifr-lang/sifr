...
fn main() {
    ...
    let mut bio: BytesIO = BytesIO::new(vec![(97 as i64) as u8, (98 as i64) as u8, (99 as i64) as u8]);
    let _seek_b: i64 = bio.seek(3 as i64, 0 as i64)?;
    let _wb: () = bio.write_bytes(&vec![(100 as i64) as u8])?;
    let _seek_b0: i64 = bio.seek(0 as i64, 0 as i64)?;
    let bytes_value: Vec<u8> = bio.read_bytes(None)?;
    bytesio_ok = bytes_value == vec![(97 as i64) as u8, (98 as i64) as u8, (99 as i64) as u8, (100 as i64) as u8];
    let __sifr_try_res: Result<(), IOError> = (|| {
    let _bad_seek_b: i64 = bio.seek(-(1 as i64), 0 as i64)?;
    let _: i64 = _bad_seek_b;
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
    ...
    let mut writer: BinaryFileHandle = open_binary(&path, &"wb".to_string())?;
    let _w_file: () = writer.write_bytes(&vec![(114 as i64) as u8, (117 as i64) as u8, (110 as i64) as u8, (116 as i64) as u8, (105 as i64) as u8, (109 as i64) as u8, (101 as i64) as u8, (45 as i64) as u8, (119 as i64) as u8, (97 as i64) as u8, (118 as i64) as u8, (101 as i64) as u8, (49 as i64) as u8])?;
    writer.close();
    let mut reader: BinaryFileHandle = open_binary(&path, &"rb".to_string())?;
    let loaded: Vec<u8> = reader.read_bytes(None)?;
    reader.close();
    binary_file_ok = loaded == vec![(114 as i64) as u8, (117 as i64) as u8, (110 as i64) as u8, (116 as i64) as u8, (105 as i64) as u8, (109 as i64) as u8, (101 as i64) as u8, (45 as i64) as u8, (119 as i64) as u8, (97 as i64) as u8, (118 as i64) as u8, (101 as i64) as u8, (49 as i64) as u8];
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
