...
mod sifr_generated_project_nominals {
    ...
    ///# Errors
    ///Returns the typed error produced by this operation.
    pub fn sifr_generated_iterdir_list(path: &str) -> Result<Vec<String>, IOError> {
        iterdir(path)
    }
    ///# Errors
    ///Returns the typed error produced by this operation.
    ...
    ///# Errors
    ///Returns the typed error produced by this operation.
    pub fn sifr_generated_rglob_list(path: &str, pattern: &str) -> Result<Vec<String>, IOError> {
        rglob_pattern(path, pattern)
    }
    ///# Errors
    ///Returns the typed error produced by this operation.
    pub fn sifr_generated_iterdir_to_iter(
        path: &str,
    ...
    ///# Errors
    ///Returns the typed error produced by this operation.
    pub fn sifr_generated_rglob_to_iter(
        path: &str,
        pattern: &str,
    ) -> Result<Box<dyn Iterator<Item = String>>, IOError> {
        let sifr_generated_try_res: Result<
    ...
    #[must_use]
    pub fn sifr_generated_iter_matches(
    ...
    #[must_use]
    pub fn sifr_generated_find_index_from(text: &str, needle: &str, start: SifrInt) -> SifrInt {
    ...
    #[must_use]
    pub fn sifr_generated_finditer_from_items(
        found_items: &[String],
        text: &str,
...
fn re_findall_flags(pattern: &str, text: &str, flags: SifrInt) -> Result<Vec<String>, RegexError> {
...
fn main() {
    ...
    let sifr_generated_try_res: Result<(), IOError> = (|| {
        let _ = run_command(&format!("mkdir -p {base}/sub"))?;
