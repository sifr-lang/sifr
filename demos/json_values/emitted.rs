...
fn main() {
    let wrapper_payload: JsonValue = from_object(&vec![("module".to_string(), from_str(&"json".to_string())), ("items".to_string(), from_array(&vec![from_int(1 as i64), from_int(2 as i64), from_int(3 as i64)]))]);
