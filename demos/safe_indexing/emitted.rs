...
fn main() {
    ...
    let ages: HashMap<String, i64> = HashMap::from([("alice".to_string(), 25 as i64), ("bob".to_string(), 30 as i64)]);
    ...
    let mut data: HashMap<String, i64> = HashMap::from([("alice".to_string(), 25 as i64), ("bob".to_string(), 30 as i64)]);
    ...
    let mut config: HashMap<String, i64> = HashMap::from([("a".to_string(), 1 as i64), ("b".to_string(), 2 as i64), ("c".to_string(), 3 as i64)]);
