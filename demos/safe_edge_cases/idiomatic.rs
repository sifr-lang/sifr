...
fn main() {
    ...
    let __sifr_try_res: Result<(), ValueError> = (|| {
        ...
        println!(
            ...
            format!(
                "{}{}{}",
                "wrap(hello world, 5) = ok (".to_string(),
                format!("{}", lines.len() as i64),
                " lines)".to_string()
            )
        );
        return Ok(());
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "wrap(hello, 0) -> ValueError: ".to_string(),
                e.message
            )
        );
    }
    ...
    let __sifr_try_res: Result<(), ValueError> = (|| {
        ...
        println!(
            ...
            format!(
                "{}{}{}",
                "batched([1,2,3,4,5], 2) = ok (".to_string(),
                format!("{}", b.len() as i64),
                " batches)".to_string()
            )
        );
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "batched(data, 0) -> ValueError: ".to_string(),
                e.message
            )
        );
    }
    ...
    let __sifr_try_res: Result<(), CycleError> = (|| {
        let order2: Vec<i64> = topological_sort(
            2 as i64,
            &vec![0 as i64, 1 as i64],
            &vec![1 as i64, 0 as i64],
        )?;
        println!("should not reach here");
        return Ok(());
    })();
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "ip_to_int(bad) -> ValueError: ".to_string(),
                e.message
            )
        );
    }
    ...
    println!(
        "{}",
        format!("{}{}", "before: ".to_string(), format!("{:?}", nums))
    );
    {
    ...
    println!(
        ...
        format!(
            "{}{}",
            "after out-of-bounds assign: ".to_string(),
            format!("{:?}", nums)
        )
    );
    {
