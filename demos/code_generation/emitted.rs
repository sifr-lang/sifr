fn main() {
    ...
    assert!(format!("{}", format!("Tuple index: {}, {}", a, b)) == "Tuple index: 10, 20".to_string());
    let x: i64 = 10 as i64;
    let y: i64 = 3 as i64;
    let result: f64 = (x as f64) / (y as f64);
    println!("Division 10/3: {}", result);
    assert!(format!("{}", format!("Division 10/3: {}", result)) == "Division 10/3: 3.3333333333333335".to_string());
    ...
    assert!(format!("{}", format!("bool([1,2,3]): {}", !nums.is_empty())) == "bool([1,2,3]): true".to_string());
    println!("bool([]): {}", !empty.is_empty());
    assert!(format!("{}", format!("bool([]): {}", !empty.is_empty())) == "bool([]): false".to_string());
