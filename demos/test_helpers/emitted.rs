...
fn pstdev(data: &Vec<f64>) -> Result<f64, StatisticsError> {
    ...
    if n == (0 as i64) {
        return Err(
            StatisticsError::new("pstdev requires at least one data point".to_string()),
        );
    }
    let avg: f64 = _sum(data) / (n as f64);
    let mut total: f64 = 0.0 as f64;
...
fn main() {
    let data: Vec<f64> = vec![2.0 as f64, 4.0 as f64, 4.0 as f64, 4.0 as f64, 5.0 as f64, 5.0 as f64, 7.0 as f64, 9.0 as f64];
    ...
    assert!(format!("{}", format!("{}{}", "mean = ".to_string(), format!("{}", m))) == "mean = 5".to_string());
    println!("{}", format!("{}{}", "sample variance = ".to_string(), format!("{}", sv)));
    assert!(format!("{}", format!("{}{}", "sample variance = ".to_string(), format!("{}", sv))) == "sample variance = 4.571428571428571".to_string());
    println!("{}", format!("{}{}", "population variance = ".to_string(), format!("{}", pv)));
    assert!(format!("{}", format!("{}{}", "population variance = ".to_string(), format!("{}", pv))) == "population variance = 4".to_string());
    println!("{}", format!("{}{}", "sample stdev = ".to_string(), format!("{}", sd)));
    assert!(format!("{}", format!("{}{}", "sample stdev = ".to_string(), format!("{}", sd))) == "sample stdev = 2.138089935299395".to_string());
    println!("{}", format!("{}{}", "population stdev = ".to_string(), format!("{}", pd)));
    assert!(format!("{}", format!("{}{}", "population stdev = ".to_string(), format!("{}", pd))) == "population stdev = 2".to_string());
    {
    let __lhs = m;
    ...
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        assert!(format!("{}", format!("{}{}", "statistics error: ".to_string(), e.message)) == "All assertions passed!".to_string());
    }
    assert!((10 as i64) > (5 as i64), "assert_gt failed: {} is not > {}", 10 as i64, 5 as i64);
    assert!((3 as i64) < (7 as i64), "assert_lt failed: {} is not < {}", 3 as i64, 7 as i64);
    assert!((100 as i64) > (0 as i64), "assert_gt failed: {} is not > {}", 100 as i64, 0 as i64);
    assert!((0 as i64) < (1 as i64), "assert_lt failed: {} is not < {}", 0 as i64, 1 as i64);
