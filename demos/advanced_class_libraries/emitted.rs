...
fn main() {
    ...
    d.append(&(3 as i64));
    d.append(&(4 as i64));
    println!("{}", format!("{}{}", "deque len (maxlen=3) = ".to_string(), format!("{}", d.len() as i64)));
    println!("{}", format!("{}{}", "deque popleft = ".to_string(), (d.popleft()).map_or("None".to_string().to_string(), |__v| format!("{}", __v))));
    let mut dt: datetime = datetime::new(2024 as i64, 6 as i64, 15 as i64, 9 as i64, 30 as i64, 0 as i64, None);
    println!("{}", format!("{}{}", "datetime isoformat = ".to_string(), dt.isoformat()));
    println!("{}", format!("{}{}", "datetime year = ".to_string(), format!("{}", dt.year)));
    let mut today: date = date::new(2024 as i64, 6 as i64, 15 as i64);
    println!("{}", format!("{}{}", "date isoformat = ".to_string(), today.isoformat()));
    let mut p: Path = Path::new("/tmp/demo_file.txt".to_string());
    let __sifr_try_res: Result<(), IOError> = (|| {
    let _: () = p.touch()?;
    println!("path touch ok = true");
    println!("{}", format!("{}{}", "path exists = ".to_string(), format!("{}", p.exists())));
    let _2: () = p.unlink()?;
    ...
    println!("{}", format!("{}{}", "with_suffix = ".to_string(), p2.with_suffix(&".csv".to_string()).to_str()));
    println!("{}", format!("{}{}", "with_name = ".to_string(), p2.with_name(&"other.txt".to_string()).to_str()));
    let __sifr_try_res: Result<(), RegexError> = (|| {
    let mut pat: Pattern = compile(&"\\d+".to_string());
    let m: bool = pat.is_match(&"abc123".to_string())?;
    println!("{}", format!("{}{}", "pattern is_match = ".to_string(), format!("{}", m)));
    let found: Option<String> = pat.search(&"hello 42 world".to_string())?;
    if let Some(found) = found {
        println!("{}", format!("{}{}", "pattern search found = ".to_string(), format!("{}", (found.chars().count() as i64) > (0 as i64))));
    }
    let nums: Vec<String> = pat.findall(&"1 plus 2 equals 3".to_string())?;
    println!("{}", format!("{}{}", "pattern findall count = ".to_string(), format!("{}", nums.len() as i64)));
    let __sifr_try_res: Result<(), RegexError> = (|| {
    let fm_val: bool = fullmatch(&"\\d+".to_string(), &"12345".to_string())?;
    println!("{}", format!("{}{}", "fullmatch digits = ".to_string(), format!("{}", fm_val)));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e2 = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "fullmatch error: ".to_string(), e2.message));
    }
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "regex error: ".to_string(), e.message));
    }
    ...
    let mut r: reader = reader::new(csv_text, None, ",".to_string(), "\"".to_string(), "".to_string(), true, false, 0 as i64);
    let all_rows: Vec<Vec<String>> = r.rows();
    println!("{}", format!("{}{}", "csv rows = ".to_string(), format!("{}", all_rows.len() as i64)));
    ...
    println!("{}", format!("{}{}", "csv writer output = ".to_string(), out));
    let mut dr: DictReader = DictReader::new("name,score\nalice,95\nbob,87".to_string(), None, "".to_string(), "".to_string(), None, ",".to_string(), "\"".to_string(), "".to_string(), true, false, 0 as i64);
    ...
    if let Some(first_header) = first_header {
        println!("{}", format!("{}{}", "dictreader headers = ".to_string(), first_header));
    }
    let dict_rows: Vec<HashMap<String, String>> = dr.rows();
    println!("{}", format!("{}{}", "dictreader row count = ".to_string(), format!("{}", dict_rows.len() as i64)));
    let mut dw: DictWriter = DictWriter::new(vec!["name".to_string(), "score".to_string()], "".to_string(), "raise".to_string(), None, ",".to_string(), "\"".to_string(), "".to_string(), true, false, "\n".to_string(), 0 as i64);
    dw.writeheader();
    ...
    println!("{}", format!("{}{}", "dictwriter output = ".to_string(), dw_out));
}
