...
fn main() {
    ...
    println!(
        ...
        format!(
            "{}{}",
            "islice(start, stop, step) = ".to_string(),
            format!(
                "{:?}",
                islice(
    ...
    println!(
        ...
        format!(
            "{}{}",
            "callable object direct = ".to_string(),
            format!("{}", doubler.__call__(4 as i64))
        )
    );
    ...
    println!(
        ...
        format!(
            "{}{}",
            "shuffle(mut items) len = ".to_string(),
    ...
    let __sifr_try_res: Result<(), ValueError> = (|| {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "choices(items, k=3) len = ".to_string(),
                format!("{}", many.len() as i64)
            )
        );
        println!(
            "{}",
            format!(
                "{}{}",
                "randrange(10) ok = ".to_string(),
                format!("{}", (rr >= (0 as i64)) && (rr < (10 as i64)))
            )
        );
        return Ok(());
    })();
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            "{}",
            format!("{}{}", "random error: ".to_string(), e.message)
        );
    }
    println!(
        "{}",
        format!(
            "{}{}",
            "secrets.compare_digest = ".to_string(),
            format!("{}", compare_digest(&"abc".to_string(), &"abc".to_string()))
        )
    );
    println!(
        "{}",
        format!(
            "{}{}",
            "secrets.token_hex(4) len = ".to_string(),
            format!("{}", token_hex(4 as i64).chars().count() as i64)
        )
    );
    let __sifr_try_res: Result<(), ValueError> = (|| {
        ...
        println!(
            ...
            format!(
                "{}{}",
                "secrets.randbits(16) ok = ".to_string(),
                format!("{}", bits >= (0 as i64))
            )
        );
        return Ok(());
    })();
    if let Err(__sifr_try_err) = __sifr_try_res {
        ...
        println!(
            "{}",
            format!("{}{}", "secrets error: ".to_string(), e.message)
        );
    }
}
