...
fn main() {
    ...
    let _w: () = std::fs::write(&path, "alpha\nbeta".to_string().as_bytes()).map(|_| ()).map_err(__io_err)?;
    ...
    let first: Option<String> = fh.readline()?;
    let second: Option<String> = fh.readline()?;
    let third: Option<String> = fh.readline()?;
    fh.close();
    text_ok = ((((first).map_or("None".to_string().to_string(), |__v| format!("{}", __v)) == "alpha".to_string()) && ((second).map_or("None".to_string().to_string(), |__v| format!("{}", __v)) == "beta".to_string())) && (third == None));
    let mut wb: FileHandle = (|| {
    let __path = path.to_string();
    ...
    let _bw: () = wb.write_bytes(&vec![(114 as i64) as u8, (97 as i64) as u8, (119 as i64) as u8, (45 as i64) as u8, (98 as i64) as u8, (121 as i64) as u8, (116 as i64) as u8, (101 as i64) as u8, (115 as i64) as u8])?;
    wb.close();
    let mut rb: FileHandle = (|| {
    let __path = path.to_string();
    ...
    rb.close();
    binary_ok = payload == vec![(114 as i64) as u8, (97 as i64) as u8, (119 as i64) as u8, (45 as i64) as u8, (98 as i64) as u8, (121 as i64) as u8, (116 as i64) as u8, (101 as i64) as u8, (115 as i64) as u8];
    return Ok(());
})();
