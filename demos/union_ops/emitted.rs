...
fn main() {
    ...
    let merged: Vec<SifrInt> = merge_lists(vec![SifrInt::from_i64(1), SifrInt::from_i64(2), SifrInt::from_i64(3)], vec![SifrInt::from_i64(4), SifrInt::from_i64(5), SifrInt::from_i64(6)]);
