...
fn main() {
    ...
    println!("{}", format!("{}{}", "pair first = ".to_string(), format!("{}", p.first)));
    println!("{}", format!("{}{}", "pair second = ".to_string(), format!("{}", p.second)));
    let p2 = p.swap();
    println!("{}", format!("{}{}", "swapped first = ".to_string(), format!("{}", p2.first)));
    println!("{}", format!("{}{}", "swapped second = ".to_string(), format!("{}", p2.second)));
    ...
    s.push(&(2 as i64));
    s.push(&(3 as i64));
    println!("{}", format!("{}{}", "stack size = ".to_string(), format!("{}", s.size())));
    let item: Option<i64> = s.pop();
    if let Some(item) = item {
        println!("{}", format!("{}{}", "popped = ".to_string(), format!("{}", item)));
    }
    println!("{}", format!("{}{}", "stack size after pop = ".to_string(), format!("{}", s.size())));
    let mut w = Wrapper::new(42 as i64);
    println!("{}", format!("{}{}", "wrapper get = ".to_string(), format!("{}", w.get())));
    let x: () = ();
    println!("{}", format!("{}{}", "x is None = ".to_string(), format!("{}", true)));
    println!("{}", format!("{}{}", "x is not None = ".to_string(), format!("{}", false)));
}
