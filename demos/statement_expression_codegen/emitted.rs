...
fn main() {
    ...
    for i in SifrRange::new_known_nonzero(SifrInt::from_i64(1), SifrInt::from_i64(6), SifrInt::from_i64(1)) {
    ...
    let verdict: String = if &total > &SifrInt::from_i64(10) { "high".to_string() } else { "low".to_string() };
    println!("total = {}", total);
