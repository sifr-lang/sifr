...
fn main() {
    ...
    let fee: Decimal =
        Decimal::from_str_exact(("3.00".to_string()).as_str()).unwrap_or_else(|__e| unreachable!());
    println!("{}", {
        let __l = cash;
        let __r = fee;
    ...
    println!(
        "{}",
        Decimal::from_str_exact(("2.5".to_string()).as_str())
            .unwrap_or_else(|__e| unreachable!())
    ...
    println!(
        ...
        <Decimal as rust_decimal::MathematicalOps>::sqrt(
            &Decimal::from_str_exact(("-4".to_string()).as_str())
                .unwrap_or_else(|__e| unreachable!())
        )
        .map_or_else(
            || Err(DecimalConversionError {
                message: "decimal.sqrt() is undefined for negative values"
                    .to_string()
                    .to_string()
            }),
            |__v| Ok(__v)
    ...
    println!(
        ...
        ("-4".to_string())
            ...
            .map_or_else(
                || Err(DecimalConversionError {
                    message: "bigdecimal.sqrt() is undefined for negative values"
                        .to_string()
                        .to_string()
                }),
