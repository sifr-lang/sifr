...
fn main() {
    ...
    let sifr_generated_try_res: Result<(), IOError> = (|| {
        ...
        writer.write_bytes(&vec![
            114u8, 117u8, 110u8, 116u8, 105u8, 109u8, 101u8, 45u8, 98u8, 105u8, 110u8, 97u8, 114u8,
            121u8, 95u8, 102u8, 105u8, 108u8, 101u8, 115u8,
        ])?;
        writer.close();
        ...
        payload_ok = loaded
            == vec![
                114u8, 117u8, 110u8, 116u8, 105u8, 109u8, 101u8, 45u8, 98u8, 105u8, 110u8, 97u8,
                114u8, 121u8, 95u8, 102u8, 105u8, 108u8, 101u8, 115u8,
            ];
        ints_ok = format!(
            "{:?}",
            loaded
