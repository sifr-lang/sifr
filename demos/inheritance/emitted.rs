...
impl Circle {
    fn new(color: String, radius: f64) -> Self {
        return Self { shape: Shape::new("Circle".to_string(), color), radius: radius };
    }
    fn area(&self) -> f64 {
...
impl Rectangle {
    fn new(color: String, width: f64, height: f64) -> Self {
        return Self { shape: Shape::new("Rectangle".to_string(), color), width: width, height: height };
    }
    fn area(&self) -> f64 {
...
fn main() {
    ...
    println!("{}", MathHelper::clamp(15.0 as f64, 0.0 as f64, 10.0 as f64));
    println!("{}", MathHelper::clamp(-(5.0 as f64), 0.0 as f64, 10.0 as f64));
