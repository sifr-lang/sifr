...
fn main() {
    ...
    let ints: Vec<i64> = chain(&vec![vec![1_i64, 2_i64], vec![3_i64, 4_i64]])
        .collect::<Vec<_>>();
    println!("{:?}", ints);
    ...
    let first3_int: Vec<i64> = take(
        3_i64,
        &(vec![10_i64, 20_i64, 30_i64, 40_i64, 50_i64]).into_iter().collect::<Vec<_>>(),
    );
    println!("{:?}", first3_int);
    ...
    let nested_int: Vec<Vec<i64>> = vec![
        vec![1_i64, 2_i64], vec![3_i64, 4_i64], vec![5_i64]
    ];
    ...
    let odds: Vec<i64> = filterfalse(
            ...
            &(vec![1_i64, 2_i64, 3_i64, 4_i64, 5_i64, 6_i64])
                .into_iter()
                .collect::<Vec<_>>(),
        )
        .collect::<Vec<_>>();
