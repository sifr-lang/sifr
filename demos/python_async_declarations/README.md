...
The generated binary starts one application-owned asyncio loop. It constructs a
real `httpx2.AsyncClient` over an offline ASGI transport, converts its typed
