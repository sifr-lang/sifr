...
fn main() {
    ...
    println!("{}", format!("{}{}", "open write ok = ".to_string(), format!("{}", (content.chars().count() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "open write error: ".to_string(), e.message));
    }
    ...
    match __mode.as_str() {
        ...
        struct __WithGuard0 { ctx: FileHandle }
    ...
    println!("{}", format!("{}{}", "context manager ok = ".to_string(), format!("{}", result == "context manager works".to_string())));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "context manager error: ".to_string(), e.message));
    }
    let __sifr_try_res: Result<(), IOError> = (|| {
    ...
    fr.close();
    println!("{}", format!("{}{}", "open read ok = ".to_string(), format!("{}", (content2.chars().count() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "open read error: ".to_string(), e.message));
    }
    let mut t: time = time::new(10 as i64, 30 as i64, 45 as i64);
    println!("{}", format!("{}{}", "time isoformat = ".to_string(), t.isoformat()));
    let t2: time = time::new(10 as i64, 30 as i64, 45 as i64);
    println!("{}", format!("{}{}", "time eq = ".to_string(), format!("{}", t == t2)));
    let tz: timezone = timezone::new(0 as i64);
    println!("{}", format!("{}{}", "timezone utc = ".to_string(), format!("{}", tz)));
    let mut dt: datetime = now(&None);
    let iso: String = dt.isoformat();
    println!("{}", format!("{}{}", "now isoformat ok = ".to_string(), format!("{}", (iso.chars().count() as i64) > (0 as i64))));
    let __sifr_try_res: Result<(), IOError> = (|| {
    let result2: CompletedProcess = run(&"echo hello_subprocess".to_string())?;
    println!("{}", format!("{}{}", "subprocess returncode = ".to_string(), format!("{}", result2.returncode)));
    println!("{}", format!("{}{}", "subprocess stdout ok = ".to_string(), format!("{}", (result2.stdout.chars().count() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "subprocess error: ".to_string(), e.message));
    }
    ...
    println!("{}", format!("{}{}", "glob found = ".to_string(), format!("{}", (matches.len() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
    ...
    println!("{}", format!("{}{}", "re ignorecase = ".to_string(), format!("{}", found.is_some())));
    let mut pat: Pattern = compile_flags(&"^line".to_string(), MULTILINE);
    let found2: Option<String> = pat.search(&"line1\nline2".to_string())?;
    println!("{}", format!("{}{}", "re multiline = ".to_string(), format!("{}", found2.is_some())));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
    ...
    println!("{}", format!("{}{}", "os getcwd ok = ".to_string(), format!("{}", (cwd.chars().count() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "os getcwd error: ".to_string(), e.message));
    }
    let items: Vec<i64> = vec![1 as i64, 2 as i64, 3 as i64, 4 as i64, 5 as i64];
    let __sifr_try_res: Result<(), ValueError> = (|| {
    let picked: i64 = choice(&items)?;
    println!("{}", format!("{}{}", "random choice ok = ".to_string(), format!("{}", (picked >= (1 as i64)) && (picked <= (5 as i64)))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "random choice error: ".to_string(), e.message));
    }
    ...
    let mut handler: FileHandler = FileHandler::new("/tmp/sifr_demo_fh_log.txt".to_string(), 0 as i64);
    ...
    println!("{}", format!("{}{}", "file handler wrote ok = ".to_string(), format!("{}", (log_content.chars().count() as i64) > (0 as i64))));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
        println!("{}", format!("{}{}", "file handler error: ".to_string(), e.message));
    }
    ...
    let mut r: reader = reader_from_path(&csv_path, &None, &",".to_string(), &"\"".to_string(), &"".to_string(), true, false, 0 as i64)?;
    let rows: Vec<Vec<String>> = r.rows();
    println!("{}", format!("{}{}", "csv reader_from_path rows = ".to_string(), format!("{}", rows.len() as i64)));
    return Ok(());
})();
    if let Err(__sifr_try_err) = __sifr_try_res {
        let e = __sifr_try_err.clone();
