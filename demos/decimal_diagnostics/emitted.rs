...
fn main() {
    ...
    assert!((format!("{}", ::bigdecimal::Context::default().with_rounding_mode(::bigdecimal::RoundingMode::HalfEven).with_prec(28).unwrap_or_else(|| ::bigdecimal::Context::default().with_rounding_mode(::bigdecimal::RoundingMode::HalfEven)).round_decimal_ref(&(b.with_scale_round(2, ::bigdecimal::RoundingMode::HalfEven)))) == "20.75000000000000000000000000"));
    assert!((format!("{}", ::bigdecimal::Context::default().with_rounding_mode(::bigdecimal::RoundingMode::HalfEven).with_prec(28).unwrap_or_else(|| ::bigdecimal::Context::default().with_rounding_mode(::bigdecimal::RoundingMode::HalfEven)).round_decimal_ref(&(b.with_scale_round(2, ::bigdecimal::RoundingMode::HalfEven)))) == "20.75000000000000000000000000"));
