...
Pass a codec descriptor to `open_text` whenever you open a text file. The `encoding=` parameter is required — omitting it raises [`SIFR-IO-0801`](/errors/SIFR-IO-0801):
