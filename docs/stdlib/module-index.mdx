...
For the exact symbol inventory, see the [compiled public API](/stdlib/public-api).
...
| Module | Purpose |
| --- | --- |
| `sifr.collections` | Counters, deques, and immutable `frozenset` values. |
...
Byte construction, search, hexadecimal formatting, and UTF-8 conversion are
first-class `bytes` operations. They do not require a stdlib import.
