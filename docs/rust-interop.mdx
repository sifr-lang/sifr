...
| `opaque_resource_package_core` | `supported-through-bridge` | `runtime-observed` |
| `opaque_resource_matrix` | `supported-through-bridge` | `runtime-observed` |
| `close_after_use` | `supported` | `runtime-observed` |
| `bridge_version_field_removal` | `supported` | `compiler-diagnostic` |
| `structural_bridge_calls` | `supported-through-bridge` | `runtime-observed` |
| `static_program_arena_bridge` | `supported-through-bridge` | `runtime-observed` |
