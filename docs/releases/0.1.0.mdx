...
- Generated-Rust output through `sifr emit` and the VS Code preview action is
  not part of the packaged `0.1.0` GA-qualified surface because cold first-run
  qualification exceeded its deterministic bound.
