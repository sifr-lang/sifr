...
If you installed Sifr to a custom directory with `SIFR_INSTALL_DIR`, remove that toolchain root. If you installed Sifr through Cargo, Homebrew, or a system package manager, uninstall it with that same tool.
