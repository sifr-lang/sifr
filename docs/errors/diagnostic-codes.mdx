...
| [`SIFR-INT-0005`](/errors/SIFR-INT-0005) | Error | Integer division, modulo, exponentiation, shift, or range step requires handling a typed failure. |
| [`SIFR-INT-0007`](/errors/SIFR-INT-0007) | Error | Bool and integer comparison requires explicit conversion. |
| [`SIFR-INT-0009`](/errors/SIFR-INT-0009) | Error | JSON or web-safe integer serialization boundary is missing or unsafe. |
| [`SIFR-META-0001`](/errors/SIFR-META-0001) | Error | Package const specialization reported a fatal issue. |
| [`SIFR-META-0002`](/errors/SIFR-META-0002) | Warning | Package const specialization reported a hard warning. |
| [`SIFR-META-0003`](/errors/SIFR-META-0003) | Error | Package const-specialization issue declaration is malformed. |
...
| [`SIFR-OWN-0014`](/errors/SIFR-OWN-0014) | Error | Unsupported mutable receiver place. |
...
| [`SIFR-PROTO-0005`](/errors/SIFR-PROTO-0005) | Error | Protocol receiver convention mismatch. |
| [`SIFR-PROTO-0006`](/errors/SIFR-PROTO-0006) | Error | Fixed Rust trait receiver convention is violated. |
...
| [`SIFR-COMPONENT-0001`](/errors/SIFR-COMPONENT-0001) | Error | Compiler component registration is invalid. |
| [`SIFR-COMPONENT-0002`](/errors/SIFR-COMPONENT-0002) | Error | Compiler component integrity verification failed. |
| [`SIFR-COMPONENT-0003`](/errors/SIFR-COMPONENT-0003) | Error | Compiler component protocol version is incompatible. |
| [`SIFR-COMPONENT-0004`](/errors/SIFR-COMPONENT-0004) | Error | Compiler component protocol envelope is invalid. |
| [`SIFR-COMPONENT-0005`](/errors/SIFR-COMPONENT-0005) | Error | Compiler component requested a forbidden capability. |
| [`SIFR-COMPONENT-0006`](/errors/SIFR-COMPONENT-0006) | Error | Compiler component exceeded a resource limit. |
| [`SIFR-COMPONENT-0007`](/errors/SIFR-COMPONENT-0007) | Error | Compiler component execution failed. |
| [`SIFR-COMPONENT-0008`](/errors/SIFR-COMPONENT-0008) | Error | Compiler component cache operation failed. |
| [`SIFR-COMPONENT-0009`](/errors/SIFR-COMPONENT-0009) | Error | Compiler component diagnostic registry is invalid. |
| [`SIFR-SQL-0001`](/errors/SIFR-SQL-0001) | Error | Database type has no common SQL mapping. |
| [`SIFR-SQL-0002`](/errors/SIFR-SQL-0002) | Error | SQL parameter bind types are incompatible. |
| [`SIFR-SQL-0003`](/errors/SIFR-SQL-0003) | Error | Nullable value cannot bind to a non-null SQL parameter. |
| [`SIFR-SQL-0004`](/errors/SIFR-SQL-0004) | Error | SQL codec contract is invalid or missing. |
| [`SIFR-SQL-0005`](/errors/SIFR-SQL-0005) | Error | Execution method conflicts with query cardinality. |
| [`SIFR-SQL-0006`](/errors/SIFR-SQL-0006) | Error | Query effect is not permitted by this SQL API. |
| [`SIFR-SQL-0007`](/errors/SIFR-SQL-0007) | Error | Provider analysis violates the common SQL contract. |
| [`SIFR-SQL-0008`](/errors/SIFR-SQL-0008) | Error | SQL handle ownership or lifetime is invalid. |
| [`SIFR-SQL-0009`](/errors/SIFR-SQL-0009) | Error | Configured SQL profile decorator has no schema-profile import. |
...
| [`SIFR-RUST-SLOT-0001`](/errors/SIFR-RUST-SLOT-0001) | Error | The reserved method-slot list is malformed. |
| [`SIFR-RUST-SLOT-0002`](/errors/SIFR-RUST-SLOT-0002) | Error | A selected method-slot target is unavailable or unsupported. |
| [`SIFR-RUST-SLOT-0003`](/errors/SIFR-RUST-SLOT-0003) | Error | A selected method has an invalid method-slot signature. |
| [`SIFR-RUST-SLOT-0004`](/errors/SIFR-RUST-SLOT-0004) | Error | A method-slot bridge bound is incomplete or misplaced. |
| [`SIFR-RUST-SLOT-0005`](/errors/SIFR-RUST-SLOT-0005) | Error | A method-slot context type or borrow mode is invalid. |
| [`SIFR-RUST-SLOT-0006`](/errors/SIFR-RUST-SLOT-0006) | Error | A method-slot handler is used outside its affine call scope. |
...
| Code | Family | Summary |
| --- | --- | --- |
| [`SIFR-PARSE-0000`](/errors/diagnostic-codes) | `PARSE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-NAME-0000`](/errors/diagnostic-codes) | `NAME` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-IMPORT-0000`](/errors/diagnostic-codes) | `IMPORT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-TYPE-0000`](/errors/diagnostic-codes) | `TYPE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-META-0000`](/errors/diagnostic-codes) | `META` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-ASYNC-0000`](/errors/diagnostic-codes) | `ASYNC` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-COMPONENT-0000`](/errors/diagnostic-codes) | `COMPONENT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-SQL-0000`](/errors/diagnostic-codes) | `SQL` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYENV-0000`](/errors/diagnostic-codes) | `PYENV` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYIMP-0000`](/errors/diagnostic-codes) | `PYIMP` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYCALL-0000`](/errors/diagnostic-codes) | `PYCALL` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYCONV-0000`](/errors/diagnostic-codes) | `PYCONV` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYRES-0000`](/errors/diagnostic-codes) | `PYRES` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYASYNC-0000`](/errors/diagnostic-codes) | `PYASYNC` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYCTX-0000`](/errors/diagnostic-codes) | `PYCTX` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYZC-0000`](/errors/diagnostic-codes) | `PYZC` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYCB-0000`](/errors/diagnostic-codes) | `PYCB` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYTRUST-0000`](/errors/diagnostic-codes) | `PYTRUST` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYTRUST-0002`](/errors/diagnostic-codes) | `PYTRUST` | Retired: import requirements and root authorization now use [`SIFR-PYTRUST-0005`](/errors/SIFR-PYTRUST-0005). |
| [`SIFR-RUST-CONFIG-0000`](/errors/diagnostic-codes) | `RUST-CONFIG` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-RESOLVE-0000`](/errors/diagnostic-codes) | `RUST-RESOLVE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-TRUST-0000`](/errors/diagnostic-codes) | `RUST-TRUST` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-TYPE-0000`](/errors/diagnostic-codes) | `RUST-TYPE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-HANDLE-0000`](/errors/diagnostic-codes) | `RUST-HANDLE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-ASYNC-0000`](/errors/diagnostic-codes) | `RUST-ASYNC` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-ZC-0000`](/errors/diagnostic-codes) | `RUST-ZC` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-CB-0000`](/errors/diagnostic-codes) | `RUST-CB` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-SLOT-0000`](/errors/diagnostic-codes) | `RUST-SLOT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-PANIC-0000`](/errors/diagnostic-codes) | `RUST-PANIC` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RUST-CARGO-0000`](/errors/diagnostic-codes) | `RUST-CARGO` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-DECIMAL-0000`](/errors/diagnostic-codes) | `DECIMAL` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-INT-0000`](/errors/diagnostic-codes) | `INT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-IO-0000`](/errors/diagnostic-codes) | `IO` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-ENCODING-0000`](/errors/diagnostic-codes) | `ENCODING` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PYRES-0001`](/errors/diagnostic-codes) | `PYRES` | Reserved for an invalid Python opaque cleanup or ownership policy. |
| [`SIFR-PYASYNC-0001`](/errors/diagnostic-codes) | `PYASYNC` | Reserved for an invalid Python awaitable, cancellation, or loop-ownership declaration. |
| [`SIFR-INT-0002`](/errors/diagnostic-codes) | `INT` | Reserved for implicit narrowing from exact or fixed-width integer sources to narrower fixed-width targets. |
| [`SIFR-INT-0008`](/errors/diagnostic-codes) | `INT` | Reserved for fixed-width array, tensor, or dataframe arithmetic without an explicit overflow policy. |
| [`SIFR-INT-0010`](/errors/diagnostic-codes) | `INT` | Reserved for bytes or bytearray construction and mutation values that do not fit uint8. |
| [`SIFR-TYPE-0903`](/errors/diagnostic-codes) | `TYPE` | Retired: direct annotated workload calls from async code are now ASYNC-family errors. |
| [`SIFR-CALL-0000`](/errors/diagnostic-codes) | `CALL` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-OWN-0000`](/errors/diagnostic-codes) | `OWN` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-FLOW-0000`](/errors/diagnostic-codes) | `FLOW` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-FMT-0000`](/errors/diagnostic-codes) | `FMT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-LINT-0000`](/errors/diagnostic-codes) | `LINT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-MATCH-0000`](/errors/diagnostic-codes) | `MATCH` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PROTO-0000`](/errors/diagnostic-codes) | `PROTO` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-CLASS-0000`](/errors/diagnostic-codes) | `CLASS` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-RESULT-0000`](/errors/diagnostic-codes) | `RESULT` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-STDLIB-0000`](/errors/diagnostic-codes) | `STDLIB` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-WORKSPACE-0000`](/errors/diagnostic-codes) | `WORKSPACE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PACKAGE-0000`](/errors/diagnostic-codes) | `PACKAGE` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-PACKAGE-0105`](/errors/diagnostic-codes) | `PACKAGE` | Retired: Cargo credential failures are wrapped by [`SIFR-PACKAGE-0101`](/errors/SIFR-PACKAGE-0101). |
| [`SIFR-PACKAGE-0302`](/errors/diagnostic-codes) | `PACKAGE` | Reserved for future backend trust diagnostics. |
| [`SIFR-PACKAGE-0306`](/errors/diagnostic-codes) | `PACKAGE` | Reserved for future backend trust and feature diagnostics. |
| [`SIFR-PACKAGE-0307`](/errors/diagnostic-codes) | `PACKAGE` | Reserved for future backend trust and feature diagnostics. |
| [`SIFR-PACKAGE-0308`](/errors/diagnostic-codes) | `PACKAGE` | Reserved for future backend trust and feature diagnostics. |
| [`SIFR-PACKAGE-0309`](/errors/diagnostic-codes) | `PACKAGE` | Reserved for future backend trust and feature diagnostics. |
| [`SIFR-CODEGEN-0000`](/errors/diagnostic-codes) | `CODEGEN` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-BUILD-0000`](/errors/diagnostic-codes) | `BUILD` | Reserved family base; not emitted as a diagnostic. |
| [`SIFR-INTERNAL-0000`](/errors/diagnostic-codes) | `INTERNAL` | Reserved family base; not emitted as a diagnostic. |
