...
Sifr reserves bare CPython standard-library names for real project modules. When no project module named `math`, `json`, or similar exists, write the supported Sifr standard-library path explicitly with `sifr.*`.
