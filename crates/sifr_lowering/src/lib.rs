...
pub use sifr_ir::{
    ...
    DeclarationDescriptorKind, DeclarationMetadataTargetKind, FlowGraph, HirDiagnostic,
    LoweringOutcome, LoweringResult, LoweringWarningDiagnostic, PythonArrowSchemaMode,
    PythonDlpackStreamMode, PythonInteropDeclaration, RevealTypeDiagnostic,
