...
//! ```
//!
//! These tokens are then consumed by the `sifr_python_parser`, which matches them against a set of
...
//!
//! During parsing, the `sifr_python_parser` consumes the tokens generated by the lexer and constructs
...
//! above, the AST generated by the `sifr_python_parser` would _roughly_ look something like this:
//!
//! ```text
//! node: Expr {
//!     value: {
...
//!```
//!
//! **Note:** The Tokens/ASTs shown above are not the exact tokens/ASTs generated by the `sifr_python_parser`.
...
//! - mode: This module contains the definition of the different modes that the `sifr_python_parser` can be in.
//!
...
///
/// ```
/// use sifr_python_parser::parse_expression;
///
...
///
/// ```
/// use sifr_python_parser::{Mode, parse};
///
