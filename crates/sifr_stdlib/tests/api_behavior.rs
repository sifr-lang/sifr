...
fn hash_leaf_matches_known_digest_vectors() {
    assert_eq!(
        sifr_stdlib::hash::sha256_bytes(b"abc"),
        vec![
    ...
    assert_eq!(
        sifr_stdlib::hash::md5_bytes(b"abc"),
        vec![
    ...
    assert_eq!(
        sifr_stdlib::hash::sha1_bytes(b"abc"),
        vec![
    ...
    assert_eq!(
        sifr_stdlib::hash::sha224_bytes(b"abc"),
        vec![
    ...
    assert_eq!(
        sifr_stdlib::hash::sha384_bytes(b"abc"),
        vec![
    ...
    assert_eq!(
        sifr_stdlib::hash::sha512_bytes(b"abc"),
        vec![
