...
pub(super) fn valid_probe() -> PythonEnvironmentProbe {
    PythonEnvironmentProbe {
        ...
        cpython_version_tuple: vec![3, 13, 0],
        executable: "/tmp/venv/bin/python".to_string(),
        sys_prefix: "/tmp/venv".to_string(),
        sys_base_prefix: "/usr/local".to_string(),
        site_packages: vec!["/tmp/venv/lib/python3.13/site-packages".to_string()],
        sys_path: vec!["/tmp/venv/lib/python3.13".to_string()],
        ...
        libpython: Some("/usr/local/lib/libpython3.13.dylib".to_string()),
        free_threaded: false,
