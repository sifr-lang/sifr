...
pub(super) fn process_child_pipe_writer_item(function_name: &str, field_name: &str) -> RustItem {
    RustItem::Fn {
        name: function_name.to_string(),
        visibility: Visibility::Private,
        type_params: vec![],
    ...
    RustItem::Fn {
        ...
        body: vec![
            ...
            RustStmt::Expr(RustExpr::Try(Box::new(process_map_err(RustExpr::FnCall {
                ...
                args: vec![
                    RustExpr::MethodCall {
                        receiver: Box::new(RustExpr::Ident("__pipe".to_string())),
            ...
            RustStmt::Return(Some(ok_expr(RustExpr::Literal(crate::RustLiteral::Unit)))),
        ],
        is_async: false,
    }
}
    ...
    RustItem::Fn {
        ...
        body: vec![
            ...
            RustStmt::Expr(RustExpr::Try(Box::new(RustExpr::MethodCall {
                receiver: Box::new(RustExpr::Ident("__removed".to_string())),
                method: "ok_or_else".to_string(),
                args: vec![RustExpr::Closure {
                    params: vec![],
                    body: Box::new(process_handle_error(
