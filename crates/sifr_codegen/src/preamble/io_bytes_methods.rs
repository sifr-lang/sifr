    ...
    RustItem::Fn {
        ...
        body: vec![
            ...
            RustStmt::Match {
                ...
                arms: vec![
                    RustMatchArm {
                        pattern: "Some(SifrFileHandle::BinaryRead(ref mut __r))".into(),
                        bindings: vec![],
                        guard: None,
                        body: vec![
                            RustStmt::Let {
    ...
    RustItem::Fn {
        ...
        body: vec![
            ...
            RustStmt::Match {
                ...
                arms: vec![
                    RustMatchArm {
                        pattern: "Some(SifrFileHandle::BinaryWrite(ref mut __w))".into(),
                        bindings: vec![],
                        guard: None,
                        body: vec![
                            RustStmt::Expr(RustExpr::Try(Box::new(RustExpr::MethodCall {
