use super::*;
#[test]
pub(super) fn lowers_simple_bare_return_without_option_context() {
...
#[test]
pub(super) fn lowers_simple_bare_return_to_none_in_option_context() {
    let stmt = HirStmt::Return { value: None };
...
#[test]
pub(super) fn lowers_simple_bare_return_to_none_in_alias_option_context() {
    let stmt = HirStmt::Return { value: None };
...
#[test]
pub(super) fn does_not_lower_bare_return_in_display_impl_context() {
    let stmt = HirStmt::Return { value: None };
...
#[test]
pub(super) fn lowers_simple_return_with_leaf_expr() {
...
#[test]
pub(super) fn lowers_simple_return_name_in_plain_context() {
    let stmt = HirStmt::Return {
...
#[test]
pub(super) fn lowers_return_leaf_with_option_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::IntLiteral(5)),
    };
    let option_ret = Type::Union(vec![Type::Int, Type::None]);
...
#[test]
pub(super) fn lowers_return_name_with_option_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
            name: "x".to_string(),
            ty: Type::Int,
...
#[test]
pub(super) fn lowers_return_option_name_in_plain_context_without_unwrap() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
...
#[test]
pub(super) fn lowers_option_name_return_with_option_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
            name: "maybe_x".to_string(),
            ty: Type::Union(vec![Type::Int, Type::None]),
...
#[test]
pub(super) fn lowers_option_name_return_with_alias_option_return_context() {
...
#[test]
pub(super) fn does_not_lower_non_leaf_option_return_passthrough_context() {
    let stmt = HirStmt::Return {
...
#[test]
pub(super) fn lowers_return_none_literal_with_option_return_context() {
    let stmt = HirStmt::Return {
...
#[test]
pub(super) fn lowers_return_none_name_with_option_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
...
#[test]
pub(super) fn lowers_return_alias_none_name_with_option_return_context() {
...
#[test]
pub(super) fn does_not_lower_non_leaf_none_typed_return_with_option_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Call {
...
#[test]
pub(super) fn does_not_lower_non_leaf_alias_none_typed_return_with_option_return_context() {
    let alias_none = Type::alias("Nothing", Type::None);
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Call {
            func: "produce_none".to_string(),
...
#[test]
pub(super) fn lowers_return_leaf_with_non_option_union_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::IntLiteral(5)),
    };
...
#[test]
pub(super) fn lowers_return_name_with_non_option_union_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
            name: "x".to_string(),
            ty: Type::Int,
...
#[test]
pub(super) fn lowers_return_leaf_with_alias_non_option_union_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::IntLiteral(5)),
    };
...
#[test]
pub(super) fn lowers_return_name_with_alias_non_option_union_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
            name: "x".to_string(),
            ty: Type::Int,
...
#[test]
pub(super) fn does_not_lower_non_leaf_return_with_non_option_union_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Call {
...
#[test]
pub(super) fn lowers_return_in_class_scope() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::IntLiteral(5)),
    };
    assert!(try_lower_simple_stmt_with_ctx(
...
#[test]
pub(super) fn lowers_self_return_in_class_scope_with_clone() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Name {
            name: "self".to_string(),
            ty: Type::Class {
...
#[test]
pub(super) fn does_not_lower_non_leaf_return_with_option_return_context() {
    let stmt = HirStmt::Return {
        value: Some(HirExpr::Call {
            func: "value".to_string(),
            args: vec![],
...
#[test]
pub(super) fn lowers_simple_raise_with_leaf_expr() {
...
#[test]
pub(super) fn does_not_lower_raise_with_non_leaf_expr() {
    let stmt = HirStmt::Raise {
        value: HirExpr::Call {
            func: "err".to_string(),
            args: vec![],
...
#[test]
pub(super) fn lowers_simple_raise_with_name_expr() {
    let stmt = HirStmt::Raise {
        value: HirExpr::Name {
            name: "e".to_string(),
            ty: Type::Int,
...
#[test]
pub(super) fn lowers_simple_assert_without_msg() {
...
#[test]
pub(super) fn lowers_simple_assert_with_leaf_msg() {
    let stmt = HirStmt::Assert {
        test: HirExpr::BoolLiteral(true),
...
#[test]
pub(super) fn lowers_simple_assert_with_name_msg() {
    let stmt = HirStmt::Assert {
        test: HirExpr::BoolLiteral(true),
...
#[test]
pub(super) fn does_not_lower_assert_with_non_leaf_test() {
    let stmt = HirStmt::Assert {
        test: HirExpr::Call {
...
#[test]
pub(super) fn lowers_simple_assert_with_bool_name_test() {
    let stmt = HirStmt::Assert {
        test: HirExpr::Name {
            name: "ok".to_string(),
            ty: Type::Bool,
...
#[test]
pub(super) fn lowers_simple_assert_with_not_bool_name_test() {
    let stmt = HirStmt::Assert {
