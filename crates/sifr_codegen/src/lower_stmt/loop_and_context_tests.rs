use super::*;
#[test]
pub(super) fn lowers_simple_while_without_else() {
...
#[test]
pub(super) fn lowers_simple_while_with_name_condition() {
    let while_stmt = HirStmt::While {
...
#[test]
pub(super) fn lowers_simple_while_with_int_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Name {
...
#[test]
pub(super) fn lowers_simple_while_with_bigint_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Name {
            name: "count".to_string(),
            ty: Type::BigInt,
...
#[test]
pub(super) fn lowers_simple_while_with_not_bool_name_condition() {
    let while_stmt = HirStmt::While {
...
#[test]
pub(super) fn lowers_simple_while_with_not_int_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::UnaryOp {
            op: "not".to_string(),
            operand: Box::new(HirExpr::Name {
...
#[test]
pub(super) fn lowers_simple_while_with_not_bigint_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::UnaryOp {
            op: "not".to_string(),
            operand: Box::new(HirExpr::Name {
...
#[test]
pub(super) fn lowers_simple_while_with_not_option_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::UnaryOp {
            op: "not".to_string(),
            operand: Box::new(HirExpr::Name {
...
#[test]
pub(super) fn lowers_simple_while_with_option_is_none_compare_condition() {
    let while_stmt = HirStmt::While {
...
#[test]
pub(super) fn lowers_simple_while_with_option_is_not_none_compare_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Compare {
            left: Box::new(HirExpr::Name {
                name: "maybe_x".to_string(),
...
#[test]
pub(super) fn lowers_simple_while_with_option_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Name {
            name: "maybe_x".to_string(),
            ty: Type::Union(vec![Type::Int, Type::None]),
...
#[test]
pub(super) fn lowers_simple_while_with_alias_option_truthiness_name_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Name {
            name: "maybe_x".to_string(),
...
#[test]
pub(super) fn does_not_lower_while_with_non_leaf_condition() {
    let while_stmt = HirStmt::While {
...
#[test]
pub(super) fn does_not_lower_while_with_non_leaf_option_truthiness_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Call {
...
#[test]
pub(super) fn does_not_lower_while_with_non_leaf_option_is_none_compare_condition() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::Compare {
...
#[test]
pub(super) fn lowers_simple_while_with_else() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::BoolLiteral(true),
        body: vec![HirStmt::Pass],
...
#[test]
pub(super) fn lowers_simple_for_without_else() {
...
#[test]
pub(super) fn lowers_simple_for_with_name_iter_using_copy_mode() {
    let for_stmt = HirStmt::For {
        target: "i".to_string(),
        target_ty: Type::Int,
        iter: HirExpr::Name {
...
#[test]
pub(super) fn lowers_simple_for_over_task_handle_list_by_value() {
...
#[test]
pub(super) fn lowers_simple_for_with_dict_iter_to_keys_cloned() {
    let for_stmt = HirStmt::For {
        target: "k".to_string(),
        target_ty: Type::Str,
        iter: HirExpr::Name {
...
#[test]
pub(super) fn does_not_lower_for_with_non_leaf_iter() {
    let for_stmt = HirStmt::For {
        target: "i".to_string(),
        target_ty: Type::Int,
        iter: HirExpr::Call {
...
#[test]
pub(super) fn lowers_simple_for_with_else() {
...
#[test]
pub(super) fn lowers_simple_for_with_else_and_name_iter() {
    let for_with_else = HirStmt::For {
        target: "i".to_string(),
        target_ty: Type::Int,
        iter: HirExpr::Name {
...
#[test]
pub(super) fn does_not_lower_for_with_else_and_non_leaf_iter() {
    let for_with_else = HirStmt::For {
        target: "i".to_string(),
        target_ty: Type::Int,
        iter: HirExpr::Call {
...
#[test]
pub(super) fn does_not_lower_for_with_tuple_target() {
...
#[test]
pub(super) fn lowers_for_else_with_broke_marker_in_loop_body() {
    let for_stmt = HirStmt::For {
        target: "i".to_string(),
        target_ty: Type::Int,
        iter: HirExpr::RangeLiteral {
...
#[test]
pub(super) fn for_else_body_break_uses_outer_loop_else_context() {
    let for_stmt = HirStmt::For {
        target: "i".to_string(),
        target_ty: Type::Int,
        iter: HirExpr::RangeLiteral {
...
#[test]
pub(super) fn lowers_while_else_with_broke_marker_in_loop_body() {
    let while_stmt = HirStmt::While {
        condition: HirExpr::BoolLiteral(true),
        body: vec![HirStmt::Break],
        else_body: Some(vec![HirStmt::Expr {
...
#[test]
pub(super) fn while_else_body_break_uses_outer_loop_else_context() {
    let while_stmt = HirStmt::While {
...
#[test]
pub(super) fn lowers_simple_yield_inside_generator_closure() {
...
#[test]
pub(super) fn lowers_simple_yield_outside_generator_closure() {
    let stmt = HirStmt::Yield {
        value: HirExpr::IntLiteral(7),
    };
    let lowered = try_lower_simple_stmt_with_ctx(
...
#[test]
pub(super) fn lowers_simple_star_unpack_from_name() {
...
#[test]
pub(super) fn lowers_simple_with_without_context_manager_protocol() {
