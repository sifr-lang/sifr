...
fn same_named_empty_dict_bindings_keep_distinct_rust_types() {
    ...
    assert!(generated.contains("let mut data: HashMap<String, SifrInt>"));
    assert!(generated.contains("let mut data: HashMap<SifrInt, SifrInt>"));
}
...
fn compatible_same_named_empty_dict_bindings_do_not_share_value_type() {
    ...
    assert!(generated.contains("let mut data: HashMap<SifrInt, f64>"));
    assert!(generated.contains("let mut data: HashMap<SifrInt, SifrInt>"));
}
