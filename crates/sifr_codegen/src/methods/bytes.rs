...
fn bind_receiver_once(object: &RustExpr, expr: RustExpr) -> RustExpr {
    RustExpr::Block {
        stmts: vec![RustStmt::Let {
            mutable: false,
...
fn bound_receiver() -> RustExpr {
    RustExpr::Ident("__bytes_receiver".to_string())
}
