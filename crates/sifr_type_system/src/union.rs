...
fn type_sort_key(ty: &Type) -> (u8, String) {
    match ty {
        ...
        Type::BlockingTask(_, _) => (22, String::new()),
        Type::Awaitable(_) => (23, String::new()),
        Type::AsyncIterator(_, _) => (24, String::new()),
        Type::AsyncGenerator(_, _) => (25, String::new()),
        Type::Unknown => (26, String::new()),
        Type::Any => (27, String::new()),
