...
fn type_sort_key(ty: &Type) -> (u8, String) {
    match ty {
        ...
        Type::TimeoutResult(_) => (21, String::new()),
        Type::Select2(_, _) => (22, String::new()),
        Type::BlockingTask(_, _) => (23, String::new()),
        Type::Awaitable(_) => (24, String::new()),
        Type::AsyncIterator(_, _) => (25, String::new()),
        Type::AsyncGenerator(_, _) => (26, String::new()),
        Type::Unknown => (27, String::new()),
