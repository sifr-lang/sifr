...
pub fn generate_profile_module(
    ...
    let mut source = format!(
        "# Generated by Sifr. Do not edit.\n# profile-identity: {}\n\nfrom enum import Enum\nfrom sifr.sql import CalendarInterval, MultiRange, Numeric, Range, SqlArray, SqlSchema\n\nclass Schema:\n    pass\n\nschema: SqlSchema[Schema]\n",
...
#[cfg(test)]
mod tests {
    use super::valid_type_expression;
    ...
    fn generated_type_expression_validation_accepts_closed_nested_types() {
        for value in [
            ...
            "sifr.sql.Range[Decimal]",
            "list[sifr.sql.Range[Decimal | None]]",
            "str | None",
        ] {
