...
pub(super) const ENTRIES: &[DiagnosticRegistryEntry] = &[
    ...
    active_entry!(
        ...
        Severity::Warning,
        "crates/sifr_driver/src/tests/single_file_frontend.rs::test_type_check_source_surfaces_arithmetic_warning_as_structured_warning",
    ...
    active_entry!(
        ...
        Severity::Error,
        "crates/sifr_lowering/src/lower/expressions_tests/basics_and_literals.rs::test_fixed_width_literal_assignment_out_of_range_has_int_code",
    ...
    active_entry!(
        ...
        Severity::Error,
        "crates/sifr_lowering/src/lower/expressions_tests/basics_and_literals.rs::test_large_integer_literal_over_budget_has_int_code",
