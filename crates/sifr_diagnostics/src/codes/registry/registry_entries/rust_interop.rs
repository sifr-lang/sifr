...
pub(super) const ENTRIES: &[DiagnosticRegistryEntry] = &[
    ...
    active_entry!(
        ...
        Severity::Error,
        "crates/sifr_driver/src/build/rust_interop_trust_tests.rs::package_rust_interop_rejects_untrusted_build_script",
    ...
    active_entry!(
        ...
        Severity::Error,
        "crates/sifr_frontend/src/slot_table_tests.rs::static_method_slot_requires_one_value_input",
