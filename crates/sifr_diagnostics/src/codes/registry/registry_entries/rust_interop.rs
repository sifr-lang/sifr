...
pub(super) const ENTRIES: &[DiagnosticRegistryEntry] = &[
    active_entry!(
        ...
        Severity::Error,
        "verification/areas/diagnostics/fixtures/diagnostics/rust_interop_malformed_decorator/main.sifr",
    ...
    active_entry!(
        ...
        Severity::Error,
        "crates/sifr_driver/src/build/rust_interop_opaque_contract_tests.rs::package_rust_interop_opaque_close_policy_requires_close_method_contract",
    ...
    active_entry!(
        ...
        Severity::Error,
        "crates/sifr_driver/src/tests/handler_descriptors.rs::owned_handler_requires_exact_self_output_at_the_descriptor",
