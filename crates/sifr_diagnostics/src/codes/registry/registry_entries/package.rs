...
pub(super) const ENTRIES: &[DiagnosticRegistryEntry] = &[
    active_entry!(
        ...
        Severity::Error,
        "verification/areas/diagnostics/fixtures/diagnostics/package_library_diagnostic_rules_cases/main.sifr",
    ...
    active_entry!(
        ...
        Severity::Error,
        "verification/areas/diagnostics/fixtures/diagnostics/package_missing_sifr_manifest/src/main.sifr",
    ...
    active_entry!(
        ...
        Severity::Error,
        "verification/areas/diagnostics/fixtures/diagnostics/package_misplaced_cargo_sifr_metadata/src/main.sifr",
