...
pub fn mark_embedded_bridge_targets(plan: &mut sifr_codegen::PythonInteropPlan) {
...
mod tests {
    use super::*;
    use crate::{
        PackagePythonRuntime, mark_embedded_bridge_targets,
    ...
    fn apply_python_interop_metadata(
    ...
    fn apply_python_interop_metadata_for_check(
        generated: GeneratedBinaryProject,
        runtime: Option<&PackagePythonRuntime>,
    ) -> Result<GeneratedBinaryProject, Vec<RenderedDiagnostic>> {
    ...
    fn apply_python_interop_metadata_with_policy(
        ...
        let Some(runtime) = runtime else {
            ...
            return Err(vec![diagnostic_with_code(
                "Python declarations require a root-selected Python environment".to_string(),
