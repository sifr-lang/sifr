...
#[path = "package_rust_interop_static_runtime_support.rs"]
mod static_runtime_support;
#[path = "package_rust_interop_structural_support.rs"]
mod structural_support;
...
fn test_build_callback_subscription_lifecycle_runtime() {
    callback_subscription_support::run_lifecycle_runtime();
}
