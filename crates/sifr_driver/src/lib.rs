...
mod build;
pub use sifr_ir::b51_phase_diagnostic;
mod diagnostics;
mod export_policy;
mod frontend;
...
pub use build::{
    ...
    CachedBinaryArtifact, CargoInvocation, MaterializedRustProjectReport, PackageEntrypoint,
    PackagePythonRuntime, PreparedSqlProfiles, PythonDeclarationCheck, PythonEnvironmentCheck,
    PythonInteropCheckReport, PythonInteropPlanDiagnostic, PythonTargetCheck,
    PythonTargetCheckStatus, PythonTargetInspection, PythonTargetParameter,
    QUERY_SIGNATURE_ARTIFACT_NAME, apply_python_target_inspection, build,
    ...
    check_single_file, emit_project, emit_query_signature_artifact, generate_dependency_cargo_toml,
    inspect_python_target, load_sql_editor_profiles, materialize_package_project,
    materialize_project, materialize_single_file, prepare_sql_profiles, probe_python_interop_plan,
