pub(super) const STDLIB_FILES: &[(&str, &str)] = &[
    ("sifr.test", include_str!("../../../../lib/sifr/test.sifr")),
    ("sifr.env", include_str!("../../../../lib/sifr/env.sifr")),
    (
        "sifr.bytes",
        include_str!("../../../../lib/sifr/bytes.sifr"),
    ),
    (
        "sifr.base64",
        include_str!("../../../../lib/sifr/base64.sifr"),
    ),
    ...
    (
        "sifr.random",
        include_str!("../../../../lib/sifr/random.sifr"),
    ),
    ...
    (
        "sifr.bisect",
        include_str!("../../../../lib/sifr/bisect.sifr"),
    ),
    (
        "sifr.functools",
    ...
    (
        "sifr.shutil",
        include_str!("../../../../lib/sifr/shutil.sifr"),
    ),
    (
        "sifr.tempfile",
    ...
    (
        "sifr.timeit",
        include_str!("../../../../lib/sifr/timeit.sifr"),
    ),
    (
        "sifr.tomllib",
