...
- loopback harness
- server accept/dispatch harness unless explicitly marked substrate
- client transport helpers used only for validation and future handoff

M4 must define the public body stream contract:
