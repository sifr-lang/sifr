# Codegen Runtime Build Gap Root Cause Breakdown (2026-04-05, v2)
...
- Breakdown CSV: `verification/leetcode/codegen_runtime_build_gap_breakdown_20260405_v2.csv`
- Reviewer pass-1 reconciliations applied: `0211`, `0729`, `0783` with emit-level evidence.

## Root Cause Families
- `recursive_field_surface_leaks_to_codegen_without_gate`: `21`
- `type_contract_emission_gap`: `19`
- `ownership_and_borrow_emission_gap`: `6`
- `binding_scope_and_capture_emission_gap`: `4`
...
## Rust Error Codes (presence count)
- `E0308`: `34`
- `E0609`: `21`
- `NO_RUST_CODE`: `7`
- `E0382`: `6`
...
- `compiler_fix`: generated Rust is invalid, panics in codegen, or violates type/ownership/binding contracts; these are compiler bugs even when fixture syntax is imperfect.
- `both`: recursive-field surface currently leaks to codegen without stable language-level handling; compiler must gate/fix, and fixture adaptation is needed unless language support is expanded.
- `sifr_adaptation`: build succeeded but runtime oracle asserts a shape/order that is not canonical under Sifr-safe semantics.
...
- `0729_my_calendar_i` | `E0277,E0596` | `binding_scope_and_capture_emission_gap` | `compiler_fix`
