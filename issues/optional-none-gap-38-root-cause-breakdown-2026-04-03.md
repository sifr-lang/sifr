...
## Current Drift Check (2026-04-03 check-only)
- Still failing: `27`
- Now passing at check stage: `11`
- Passes with warnings: `3`

## Largest Unresolved Subcategories (Current 27 Failures)
- `cluster_index_based_optional_leakage`: `5` -> 0105_construct_binary_tree_from_preorder_and_inorder_traversal, 0261_graph_valid_tree, 0287_find_the_duplicate_number, 0802_find_eventual_safe_states, 1423_maximum_points_you_can_obtain_from_cards
- `cluster_heap_pop_optional_unpack`: `3` -> 0778_swim_in_rising_water, 1584_min_cost_to_connect_all_points, 1631_path_with_minimum_effort
- `cluster_parse_result_and_optional_stack`: `3` -> 0150_evaluate_reverse_polish_notation, 0394_decode_string, 0567_permutation_in_string
- `cluster_cfg_narrowing_for_builtin_min_max`: `2` -> 0057_insert_interval, 0064_minimum_path_sum
- `cluster_container_element_optional_contamination`: `2` -> 0139_word_break, 0904_fruit_into_baskets
- `cluster_recursive_argument_optional_leakage`: `2` -> 0329_longest_increasing_path_in_a_matrix, 0417_pacific_atlantic_water_flow
- `cluster_string_index_optional_leakage`: `2` -> 0438_find_all_anagrams_in_a_string, 1397_find_all_good_strings
- `cluster_binary_search_index_optional_arithmetic`: `1` -> 0875_koko_eating_bananas
- `cluster_none_comparison_and_matrix_indexing`: `1` -> 0304_range_sum_query_2d_immutable
- `cluster_optional_sentinel_return_shape`: `1` -> 1980_find_unique_binary_string
- `cluster_recursive_constructor_nullable_arg`: `1` -> 0108_convert_sorted_array_to_binary_search_tree
- `cluster_recursive_container_boundary`: `1` -> 0103_binary_tree_zigzag_level_order_traversal
- `cluster_stdlib_compat_counter_surface`: `1` -> 0047_permutations_ii
- `cluster_stdlib_compat_deque_surface`: `1` -> 1203_sort_items_by_groups_respecting_dependencies
- `cluster_two_pointer_index_optional_arithmetic`: `1` -> 0977_squares_of_a_sorted_array
...
current check: type error: argument 1 ('source') of function '__compat_sifr_collections_Counter': expected 'None | dict[T, int]', got 'list[int]'
...
current check: type error: min() with 2 arguments does not accept optional operands; got 'int | None' and 'int | None' (guard or unwrap first)
...
current check: type error: min() with 2 arguments does not accept optional operands; got 'float | None' and 'float | None' (guard or unwrap first)
...
current check: type error: cannot compare 'list[list[int]]' and 'None' with ==
...
current check: type error: unsupported operand type(s) for +: 'int | None' and 'int'
...
current status: fail (exit=1)
snapshot: type error: argument 1 ('val') of function 'TreeNode': expected 'int', got 'int | None'
current check: type error: argument 1 ('val') of function 'TreeNode': expected 'int', got 'int | None'
...
current check: type error: list subscript assignment value type 'bool | None' is not compatible with list element type 'bool'
...
current check: type error: return type mismatch: expected 'int', got 'Result[int, ParseError] | None'
...
current check: type error: argument 1 of callable 'union': expected 'int', got 'int | None'
...
current check: type error: cannot index type 'list[int]' with 'None | int'
...
current check: type error: cannot compare 'None' and 'int' with ==
...
current check: type error: argument 3 of callable 'dfs': expected 'int', got 'int | None'
...
current check: type error: type 'None | str' has no method 'isdigit'
...
current check: type error: argument 4 of callable 'dfs': expected 'int', got 'int | None'
...
current check: type error: 'in' operator: element type 'str | None' is not compatible with collection element type 'str'
...
current check: type error: ord() argument must be 'str', got 'str | None'
...
current check: type error: cannot unpack non-tuple type 'None | list[int | None]'
...
current check: type error: cannot iterate over type 'list[int] | None'
...
current check: type error: return type mismatch: expected 'int', got 'int | None'
...
current check: type error: dict subscript assignment key type 'int | None' is not compatible with dict key type 'int'
...
current check: type error: abs() argument must be numeric, got 'int | None'
...
current check: type error: argument 1 ('items') of function '__compat_sifr_collections_deque': expected 'None | list[T]', got 'Iterator[int]'
...
current check: type error: cannot index type 'str' with 'int | None'
...
current status: fail (exit=1)
snapshot: type error: unsupported operand type(s) for -: 'int | None' and 'int | None'
current check: type error: unsupported operand type(s) for -: 'int | None' and 'int | None'
...
current check: type error: cannot unpack non-tuple type 'None | list[int]'
...
current check: type error: cannot unpack non-tuple type 'None | tuple[int, int, int]'
...
current check: type error: if expression branches have incompatible types: 'None' and 'str'
