...
- `2026-06-01`: `scripts/run_all_tests.sh --profile quick` -> PASS after final M1 reviewer fixes; report `target/validation_lane_reports/quick.latest.json`, wall time 233.87s.
