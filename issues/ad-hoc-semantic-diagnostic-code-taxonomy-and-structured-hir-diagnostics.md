...
- [ ] `milestone_diag_4a` slice 2b.26 implementation complete and reviewer-satisfied: builtin call arity, unexpected keyword, duplicate argument, and map callable arity diagnostics migration to active `SIFR-CALL-0001`, `SIFR-CALL-0002`, `SIFR-CALL-0003`, and `SIFR-CALL-0005` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1698.
