...
- [ ] `milestone_diag_4a` slice 2b.7 implementation complete and reviewer-satisfied: HIR missing type-annotation diagnostics migration to active `SIFR-TYPE-0004` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1679.
