...
- [ ] `milestone_diag_4a` slice 2b.17 implementation complete and reviewer-satisfied: immutable parameter mutation and reassignment diagnostics migration to active `SIFR-OWN-0005` and `SIFR-OWN-0006` with fixture coverage. PR: pending.
