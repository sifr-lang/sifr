...
- [ ] `milestone_diag_4a` slice 2b.22 in progress: iterator and reversible protocol signature return diagnostics migration to active `SIFR-PROTO-0002` with fixture coverage. PR: pending.
