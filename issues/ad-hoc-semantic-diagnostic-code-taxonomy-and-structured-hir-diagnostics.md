...
- [x] `milestone_diag_9` slice 19 implementation complete and reviewer-satisfied: attached primary ranges to unknown type annotation diagnostics (`SIFR-NAME-0003`) for simple and generic annotation names, with HIR primary-range assertions and e2e column anchors. PR: pending.
