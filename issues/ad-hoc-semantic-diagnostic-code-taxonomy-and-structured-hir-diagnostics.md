...
- [ ] `milestone_diag_4a` slice 2b.10 implementation complete and reviewer-satisfied: TypeVar bound/constraint declaration shape diagnostics migration to active `SIFR-TYPE-0007` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1682.
