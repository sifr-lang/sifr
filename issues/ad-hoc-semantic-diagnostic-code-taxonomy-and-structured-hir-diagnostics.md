...
- [ ] `milestone_diag_4a` slice 2b.31 implementation complete and reviewer-satisfied: builtin `zip()`, `range()`, and `enumerate()` unexpected keyword diagnostics migration to active `SIFR-CALL-0002` with fixture and HIR coverage. PR: pending.
