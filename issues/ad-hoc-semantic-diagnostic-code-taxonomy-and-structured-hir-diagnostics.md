...
- [ ] `milestone_diag_4a` slice 2b.24 implementation complete and reviewer-satisfied: class initializer, field-order, enum duplicate-value, and missing-field diagnostics migration to active `SIFR-CLASS-0001` through `SIFR-CLASS-0004` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1696.
