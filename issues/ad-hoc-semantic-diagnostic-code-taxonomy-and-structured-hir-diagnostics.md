...
- [ ] `milestone_diag_4a` slice 2b.9 implementation complete and reviewer-satisfied: HIR container literal element/key/value conflict diagnostics migration to active `SIFR-TYPE-0008` with fixture coverage. PR: pending.
