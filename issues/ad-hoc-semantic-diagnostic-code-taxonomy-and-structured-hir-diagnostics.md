...
- [x] `milestone_diag_11` expression tuple/class method raw HIR diagnostic migration slice implementation complete and reviewer-satisfied: migrated tuple, class, callable-field, protocol, newtype, enum, bigint, and default method diagnostics to structured call/type/class/protocol/stdlib diagnostics with primary ranges. PR: pending.
