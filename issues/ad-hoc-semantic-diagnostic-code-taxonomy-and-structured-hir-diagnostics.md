...
- [ ] `milestone_diag_4a` slice 2b.13 implementation complete and reviewer-satisfied: generic type alias and class annotation arity/surface diagnostics migration to active `SIFR-TYPE-0007` with fixture coverage. PR: pending.
