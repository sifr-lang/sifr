...
Current wave: `milestone_diag_11` final guardrails and baseline regeneration, split into reviewable guardrail-audit, residual HIR transport cleanup, raw HIR diagnostic migration, and final phase-closure slices.
...
- [x] `milestone_diag_11` expression dict-method raw HIR diagnostic migration slice implementation complete and reviewer-satisfied: migrated dict method arity, key/default/value type, and missing-method diagnostics to structured call/type/stdlib diagnostics with primary ranges. PR: pending.
