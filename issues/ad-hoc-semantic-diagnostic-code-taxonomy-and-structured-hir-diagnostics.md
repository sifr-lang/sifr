...
- [ ] `milestone_diag_4a` slice 2b.11 implementation complete and reviewer-satisfied: enum, protocol, and newtype method missing parameter annotation diagnostics migration to active `SIFR-TYPE-0004` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1683.
