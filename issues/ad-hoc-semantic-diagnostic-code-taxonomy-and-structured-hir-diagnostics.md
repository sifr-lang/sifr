...
- [ ] `milestone_diag_4a` slice 2b.6 implementation complete and reviewer-satisfied: `SIFR-TYPE-0009` registry hygiene for representative fixture and message-template alignment after unpack-shape migrations. PR pending.
