...
- [ ] `milestone_diag_4a` slice 2b.5 implementation complete and reviewer-satisfied: HIR for-loop tuple destructuring and star-unpack list-shape diagnostics migration to active `SIFR-TYPE-0009` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1677.
