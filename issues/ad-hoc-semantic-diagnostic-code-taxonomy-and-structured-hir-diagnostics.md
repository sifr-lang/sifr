...
- [ ] `milestone_diag_4a` slice 2b.21 implementation complete and reviewer-satisfied: context-manager protocol diagnostics migration to active `SIFR-PROTO-0003` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1693.
