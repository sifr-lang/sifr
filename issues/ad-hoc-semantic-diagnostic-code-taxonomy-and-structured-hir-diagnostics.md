...
- [ ] `milestone_diag_4a` slice 2b.29 implementation complete and reviewer-satisfied: shared missing required argument diagnostic migration to active `SIFR-CALL-0004` with fixture and registry representative coverage. PR: https://github.com/sifr-lang/sifr/pull/1701.
