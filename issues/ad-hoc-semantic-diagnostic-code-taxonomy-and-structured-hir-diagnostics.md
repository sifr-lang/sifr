...
- [ ] `milestone_diag_4a` slice 2b.18 reviewed and ready for PR: match exhaustiveness, guard, and class-pattern-field diagnostics migration to active `SIFR-MATCH-0001` through `SIFR-MATCH-0003` with fixture coverage. PR: pending.
