...
- [ ] `milestone_diag_4a` slice 2b.27 implementation complete and reviewer-satisfied: `hash()` hashability protocol diagnostic migration to active `SIFR-PROTO-0004` with fixture coverage. PR: pending.
