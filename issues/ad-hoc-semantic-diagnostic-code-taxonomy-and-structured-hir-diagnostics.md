...
- [ ] `milestone_diag_4a` slice 2b.4 implementation complete and reviewer-satisfied: HIR reassignment type-mismatch and tuple-unpack shape diagnostics migration to active `SIFR-TYPE-0002` and `SIFR-TYPE-0009` codes with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1676.
