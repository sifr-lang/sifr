...
- [ ] `milestone_diag_4a` slice 2b.23 implementation complete and reviewer-satisfied: TypeVar constraint application diagnostics migration to active `SIFR-TYPE-0010` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1695.
