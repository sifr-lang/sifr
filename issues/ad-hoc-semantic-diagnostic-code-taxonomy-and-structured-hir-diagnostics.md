...
- [ ] `milestone_diag_4a` slice 2b.25 implementation complete and reviewer-satisfied: unsupported `defaultdict()` keyword constructor diagnostic migration to active `SIFR-STDLIB-0001` with fixture coverage. PR: pending.
