...
- [ ] `milestone_diag_4a` slice 2b.12 implementation complete and reviewer-satisfied: unknown simple and generic type annotation diagnostics migration to active `SIFR-NAME-0003` with fixture coverage. PR: pending.
