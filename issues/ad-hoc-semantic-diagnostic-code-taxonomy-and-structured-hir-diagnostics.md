...
- [ ] `milestone_diag_4a` slice 2b.28 implementation complete and reviewer-satisfied: shared wrong positional argument count diagnostic migration to active `SIFR-CALL-0001` with stdlib fixture coverage. PR: pending.
