...
- [x] `milestone_diag_11` expression list-method raw HIR diagnostic migration slice implementation complete and reviewer-satisfied: migrated list method arity, sort/pop/index type, and missing-method diagnostics to structured call/type/stdlib diagnostics with primary ranges. PR: pending.
