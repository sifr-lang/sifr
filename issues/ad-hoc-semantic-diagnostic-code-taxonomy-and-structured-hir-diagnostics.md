...
- [ ] `milestone_diag_4a` slice 2b.30 implementation complete and reviewer-satisfied: shared unexpected keyword argument diagnostic migration to active `SIFR-CALL-0002` with fixture and method-helper coverage. PR: pending.
