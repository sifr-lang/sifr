...
- [ ] `milestone_diag_4a` slice 2b.20 implementation complete and reviewer-satisfied: protocol-bound diagnostics migration to active `SIFR-PROTO-0001` with fixture coverage. PR: pending.
