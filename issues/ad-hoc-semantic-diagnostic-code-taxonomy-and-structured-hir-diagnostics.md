...
- [ ] `milestone_diag_4a` slice 2b.23 implementation complete and reviewer-satisfied: TypeVar constraint application diagnostics migration to active `SIFR-TYPE-0010` with fixture coverage. PR: pending.
