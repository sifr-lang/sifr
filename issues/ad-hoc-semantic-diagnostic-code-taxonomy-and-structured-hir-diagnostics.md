...
- [ ] `milestone_diag_4a` slice 2b.22 implementation complete and reviewer-satisfied: iterator and reversible protocol signature return diagnostics migration to active `SIFR-PROTO-0002` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1694.
