...
- [x] `milestone_diag_11` expression open/callable-call raw HIR diagnostic migration slice implementation complete and reviewer-satisfied: migrated `open()` missing path, Callable-typed variable call arity/type, and the non-simple callable-object guard to structured call/type diagnostics with primary ranges. PR: pending.
