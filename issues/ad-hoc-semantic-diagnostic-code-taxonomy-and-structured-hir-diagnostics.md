...
- [ ] `milestone_diag_4a` slice 2b.3 implementation complete and reviewer-satisfied: HIR expected/actual and if-expression branch type-mismatch migration to active `SIFR-TYPE-0002` and `SIFR-TYPE-0003` codes with fixture re-keying. PR pending.
