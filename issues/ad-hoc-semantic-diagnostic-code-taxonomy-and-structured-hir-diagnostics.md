...
- [ ] `milestone_diag_4a` slice 2b.15 implementation complete and reviewer-satisfied: ownership move, borrow-conflict, borrow-escape, and loop-move diagnostics migration to active `SIFR-OWN-0001` through `SIFR-OWN-0004` with fixture coverage. PR: pending.
