...
- [ ] `milestone_diag_4a` slice 2b.8 implementation complete and reviewer-satisfied: HIR invalid type-annotation shape diagnostics migration to active `SIFR-TYPE-0007` with fixture coverage. PR: https://github.com/sifr-lang/sifr/pull/1680.
