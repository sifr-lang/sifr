...
Status: in_progress (started 2026-03-20; `wave_psp_iter_fix_0` implemented locally with architecture/governance lock artifacts, baseline fracture evidence, and validation fixtures)
