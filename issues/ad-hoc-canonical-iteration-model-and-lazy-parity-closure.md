...
Status: in_progress (started 2026-03-20; `wave_psp_iter_fix_0` implementation merged with architecture/governance lock artifacts and completion/production review approvals; `wave_psp_iter_fix_1` pending)
